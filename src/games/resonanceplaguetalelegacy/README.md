...
- PsychoV can emulate the SDR display response with None, gamma 2.2, or BT.1886 options. Gamma 2.2 is the default; the correction is applied to both the scene and confirmed HUD draws before their fixed sRGB intermediate encode, matching the native HDR transform's sRGB decoder without affecting Vanilla.
