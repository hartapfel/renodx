...
float4 main(
  ...
  float resonance_game_nits = ResonanceGetGameNits(User_000.UserConstant_Z_000[0].x);
  float _44 = resonance_game_nits * _39;
  float _45 = resonance_game_nits * _40;
  float _46 = resonance_game_nits * _41;
  // RenoDX: apply HDR-aware sharpening before the game's display transform.
  float3 resonance_sharpened_input = ResonanceApplyLiliumHDRRCAS(
      float3(_44, _45, _46),
      TEXCOORD.xy,
      t0,
      s0,
      resonance_game_nits);
  _44 = resonance_sharpened_input.x;
  _45 = resonance_sharpened_input.y;
  _46 = resonance_sharpened_input.z;
  ...
  bool _107 = (_106 == 0);
  if (!_107) {
    float _109 = renodx::color::y::from::BT2020(resonance_bt2020_nits);
    _111 = _109;
    _112 = _109;
    _113 = _109;
  } else {
    _111 = resonance_bt2020_nits.x;
    _112 = resonance_bt2020_nits.y;
    _113 = resonance_bt2020_nits.z;
  }
