...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _949 = resonance_scaled_lut_output.x;
  _950 = resonance_scaled_lut_output.y;
  _951 = resonance_scaled_lut_output.z;
  bool _954 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_954) {
  ...
  _1610 = resonance_film_grain_output.x;
  _1611 = resonance_film_grain_output.y;
  _1612 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1652 = resonance_post_process_output.x;
  float _1653 = resonance_post_process_output.y;
  float _1654 = resonance_post_process_output.z;
