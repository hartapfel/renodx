...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _475 = resonance_scaled_lut_output.x;
  _476 = resonance_scaled_lut_output.y;
  _477 = resonance_scaled_lut_output.z;
  bool _480 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_480) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1040 = resonance_perceptual_film_grain.x;
  ...
  float _1054 = resonance_perceptual_film_grain.y;
  ...
  float _1067 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1080 = resonance_post_process_output.x;
  float _1081 = resonance_post_process_output.y;
  float _1082 = resonance_post_process_output.z;
