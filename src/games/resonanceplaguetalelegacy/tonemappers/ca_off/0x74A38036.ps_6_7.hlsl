...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _917 = resonance_scaled_lut_output.x;
  _918 = resonance_scaled_lut_output.y;
  _919 = resonance_scaled_lut_output.z;
  bool _922 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_922) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1482 = resonance_perceptual_film_grain.x;
  ...
  float _1496 = resonance_perceptual_film_grain.y;
  ...
  float _1509 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1522 = resonance_post_process_output.x;
  float _1523 = resonance_post_process_output.y;
  float _1524 = resonance_post_process_output.z;
