...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _946 = resonance_scaled_lut_output.x;
  _947 = resonance_scaled_lut_output.y;
  _948 = resonance_scaled_lut_output.z;
  bool _951 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_951) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1511 = resonance_perceptual_film_grain.x;
  ...
  float _1525 = resonance_perceptual_film_grain.y;
  ...
  float _1538 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1551 = resonance_post_process_output.x;
  float _1552 = resonance_post_process_output.y;
  float _1553 = resonance_post_process_output.z;
