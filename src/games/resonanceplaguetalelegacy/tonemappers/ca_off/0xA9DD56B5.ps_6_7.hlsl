...
float4 main(
  ...
  resonance_scaled_lut_output = ResonanceApplyPerceptualFilmGrain(
      resonance_scaled_lut_output,
      SV_Position.xy);
  _522 = resonance_scaled_lut_output.x;
  _523 = resonance_scaled_lut_output.y;
  _524 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_film_grain_output = ResonanceSelectFilmGrainOutput(
      ...
      resonance_scaled_lut_output);
  _621 = resonance_film_grain_output.x;
  _622 = resonance_film_grain_output.y;
  _623 = resonance_film_grain_output.z;
  bool _626 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_626) {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      false);
  _712 = resonance_post_process_output.x;
  _713 = resonance_post_process_output.y;
  _714 = resonance_post_process_output.z;
