...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _868 = resonance_scaled_lut_output.x;
  _869 = resonance_scaled_lut_output.y;
  _870 = resonance_scaled_lut_output.z;
  bool _873 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_873) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1433 = resonance_perceptual_film_grain.x;
  ...
  float _1447 = resonance_perceptual_film_grain.y;
  ...
  float _1460 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1473 = resonance_post_process_output.x;
  float _1474 = resonance_post_process_output.y;
  float _1475 = resonance_post_process_output.z;
