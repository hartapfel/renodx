...
float4 main(
  ...
  bool _527 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_527) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1087 = resonance_perceptual_film_grain.x;
  ...
  float _1101 = resonance_perceptual_film_grain.y;
  ...
  float _1114 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1127 = resonance_post_process_output.x;
  float _1128 = resonance_post_process_output.y;
  float _1129 = resonance_post_process_output.z;
