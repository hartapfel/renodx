...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _425 = resonance_scaled_lut_output.x;
  _426 = resonance_scaled_lut_output.y;
  _427 = resonance_scaled_lut_output.z;
  bool _430 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_430) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _990 = resonance_perceptual_film_grain.x;
  ...
  float _1004 = resonance_perceptual_film_grain.y;
  ...
  float _1017 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1030 = resonance_post_process_output.x;
  float _1031 = resonance_post_process_output.y;
  float _1032 = resonance_post_process_output.z;
