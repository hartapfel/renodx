...
float4 main(
  ...
  float _507 = ResonanceScaleVignetteMask(exp2(_506));
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _560 = resonance_scaled_lut_output.x;
  _561 = resonance_scaled_lut_output.y;
  _562 = resonance_scaled_lut_output.z;
  bool _565 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_565) {
  ...
  _1221 = resonance_film_grain_output.x;
  _1222 = resonance_film_grain_output.y;
  _1223 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1263 = resonance_post_process_output.x;
  float _1264 = resonance_post_process_output.y;
  float _1265 = resonance_post_process_output.z;
