...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _911 = resonance_scaled_lut_output.x;
  _912 = resonance_scaled_lut_output.y;
  _913 = resonance_scaled_lut_output.z;
  bool _916 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_916) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1476 = resonance_perceptual_film_grain.x;
  ...
  float _1490 = resonance_perceptual_film_grain.y;
  ...
  float _1503 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1516 = resonance_post_process_output.x;
  float _1517 = resonance_post_process_output.y;
  float _1518 = resonance_post_process_output.z;
