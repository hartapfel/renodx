...
float4 main(
  ...
  bool _907 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_907) {
  ...
  float _1460 = resonance_scaled_lut_output.x;
  ...
  float _1474 = resonance_scaled_lut_output.y;
  ...
  float _1487 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1500 = resonance_post_process_output.x;
  float _1501 = resonance_post_process_output.y;
  float _1502 = resonance_post_process_output.z;
