...
float4 main(
  ...
  if (!ResonanceIsPsychoV()) {
    float _670 = resonance_scaled_lut_output.x;
    ...
    float _684 = resonance_scaled_lut_output.y;
    ...
    float _697 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _710 = resonance_post_process_output.x;
  float _711 = resonance_post_process_output.y;
  float _712 = resonance_post_process_output.z;
  float _713 = log2(_710);
  float _714 = log2(_711);
  float _715 = log2(_712);
  float _716 = _713 * 0.4166666567325592f;
  float _717 = _714 * 0.4166666567325592f;
  float _718 = _715 * 0.4166666567325592f;
  float _719 = exp2(_716);
  float _720 = exp2(_717);
  float _721 = exp2(_718);
  float _722 = _719 * 1.0549999475479126f;
  float _723 = _720 * 1.0549999475479126f;
  float _724 = _721 * 1.0549999475479126f;
  float _725 = _722 + -0.054999999701976776f;
  float _726 = _723 + -0.054999999701976776f;
  float _727 = _724 + -0.054999999701976776f;
  float _728 = _710 * 12.920000076293945f;
  float _729 = _711 * 12.920000076293945f;
  float _730 = _712 * 12.920000076293945f;
  bool _731 = (_710 <= 0.0031308000907301903f);
  bool _732 = (_711 <= 0.0031308000907301903f);
  bool _733 = (_712 <= 0.0031308000907301903f);
  float _734 = select(_731, _728, _725);
  float _735 = select(_732, _729, _726);
  float _736 = select(_733, _730, _727);
  float _737 = log2(_734);
  float _738 = log2(_735);
  float _739 = log2(_736);
  float _740 = floor(_737);
  float _741 = floor(_738);
  float _742 = floor(_739);
  float _743 = _740 + -6.0f;
  float _744 = _741 + -6.0f;
  float _745 = _742 + -5.0f;
  ...
  bool _750 = (_735 <= 0.0f);
  bool _751 = (_736 <= 0.0f);
  float _752 = select(_749, 0.0f, _746);
  float _753 = select(_750, 0.0f, _747);
  float _754 = select(_751, 0.0f, _748);
  int _757 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  uint _758 = uint(SV_Position.x);
  uint _759 = uint(SV_Position.y);
  int _760 = _758 & 63;
  int _761 = _759 & 63;
  float4 _763 = t1.Load(int4(_760, _761, _757, 0));
  float4 _766 = t6.Load(int4(_760, _761, _757, 0));
  float _769 = _763.x * _752;
  float _770 = _766.x * _753;
  float _771 = _766.y * _754;
  float _772 = _769 + _734;
  float _773 = _770 + _735;
  float _774 = _771 + _736;
  SV_Target.x = _772;
  SV_Target.y = _773;
  SV_Target.z = _774;
  SV_Target.w = _134.w;
