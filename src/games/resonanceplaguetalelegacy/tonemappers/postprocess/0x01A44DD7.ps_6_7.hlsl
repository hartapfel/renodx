...
float4 main(
  ...
  float _912 = resonance_scaled_lut_output.x;
  float _913 = resonance_scaled_lut_output.y;
  float _914 = resonance_scaled_lut_output.z;
  ...
  _1011 = resonance_film_grain_output.x;
  _1012 = resonance_film_grain_output.y;
  _1013 = resonance_film_grain_output.z;
  bool _1016 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_1016) {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      false);
  _1102 = resonance_post_process_output.x;
  _1103 = resonance_post_process_output.y;
  _1104 = resonance_post_process_output.z;
