...
float4 main(
  ...
  if (!ResonanceIsPsychoV()) {
    float _911 = resonance_scaled_lut_output.x;
    float _912 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
    float _913 = log2(_911);
    float _914 = _912 * _913;
    float _915 = exp2(_914);
    float _916 = _915 + -1.0f;
    float _917 = _911 + -1.0f;
    float _918 = _916 / _917;
    bool _919 = !(_911 == 1.0f);
    float _920 = _918 + -1.0f;
    float _921 = _920 / _918;
    float _922 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _923 = _922 / _912;
    _924 = select(_919, _921, _923);
    float _925 = resonance_scaled_lut_output.y;
    float _926 = log2(_925);
    float _927 = _926 * _912;
    float _928 = exp2(_927);
    float _929 = _928 + -1.0f;
    float _930 = _925 + -1.0f;
    float _931 = _929 / _930;
    bool _932 = !(_925 == 1.0f);
    float _933 = _931 + -1.0f;
    float _934 = _933 / _931;
    float _935 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _936 = _935 / _912;
    _937 = select(_932, _934, _936);
    float _938 = resonance_scaled_lut_output.z;
    float _939 = log2(_938);
    float _940 = _939 * _912;
    float _941 = exp2(_940);
    float _942 = _941 + -1.0f;
    float _943 = _938 + -1.0f;
    ...
    float _949 = _948 / _912;
    _950 = select(_945, _947, _949);
  } else {
    _924 = 0.f;
    _937 = 0.f;
    _950 = 0.f;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      float3(_924, _937, _950),
      true);
  float _951 = resonance_post_process_output.x;
  float _952 = resonance_post_process_output.y;
  float _953 = resonance_post_process_output.z;
  float _954 = log2(_951);
  float _955 = log2(_952);
  float _956 = log2(_953);
  float _957 = _954 * 0.4166666567325592f;
  float _958 = _955 * 0.4166666567325592f;
  float _959 = _956 * 0.4166666567325592f;
  float _960 = exp2(_957);
  float _961 = exp2(_958);
  float _962 = exp2(_959);
  float _963 = _960 * 1.0549999475479126f;
  float _964 = _961 * 1.0549999475479126f;
  float _965 = _962 * 1.0549999475479126f;
  float _966 = _963 + -0.054999999701976776f;
  float _967 = _964 + -0.054999999701976776f;
  float _968 = _965 + -0.054999999701976776f;
  float _969 = _951 * 12.920000076293945f;
  float _970 = _952 * 12.920000076293945f;
  float _971 = _953 * 12.920000076293945f;
  bool _972 = (_951 <= 0.0031308000907301903f);
  bool _973 = (_952 <= 0.0031308000907301903f);
  bool _974 = (_953 <= 0.0031308000907301903f);
  float _975 = select(_972, _969, _966);
  float _976 = select(_973, _970, _967);
  float _977 = select(_974, _971, _968);
  float _978 = log2(_975);
  float _979 = log2(_976);
  float _980 = log2(_977);
  float _981 = floor(_978);
  float _982 = floor(_979);
  float _983 = floor(_980);
  float _984 = _981 + -6.0f;
  float _985 = _982 + -6.0f;
  float _986 = _983 + -5.0f;
  float _987 = exp2(_984);
  float _988 = exp2(_985);
  float _989 = exp2(_986);
  bool _990 = (_975 <= 0.0f);
  bool _991 = (_976 <= 0.0f);
  bool _992 = (_977 <= 0.0f);
  float _993 = select(_990, 0.0f, _987);
  float _994 = select(_991, 0.0f, _988);
  float _995 = select(_992, 0.0f, _989);
  int _998 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  uint _999 = uint(SV_Position.x);
  uint _1000 = uint(SV_Position.y);
  int _1001 = _999 & 63;
  int _1002 = _1000 & 63;
  float4 _1004 = t1.Load(int4(_1001, _1002, _998, 0));
  float4 _1007 = t6.Load(int4(_1001, _1002, _998, 0));
  float _1010 = _1004.x * _993;
  float _1011 = _1007.x * _994;
  float _1012 = _1007.y * _995;
  float _1013 = _1010 + _975;
  float _1014 = _1011 + _976;
  float _1015 = _1012 + _977;
  SV_Target.x = _1013;
  SV_Target.y = _1014;
  SV_Target.z = _1015;
  SV_Target.w = _377;
