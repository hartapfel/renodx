...
float4 main(
  ...
  _519 = resonance_scaled_lut_output.x;
  _520 = resonance_scaled_lut_output.y;
  _521 = resonance_scaled_lut_output.z;
  bool _524 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_524) {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      false);
  _611 = resonance_post_process_output.x;
  _612 = resonance_post_process_output.y;
  _613 = resonance_post_process_output.z;
