...
float4 main(
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _812 = resonance_post_process_output.x;
  float _813 = resonance_post_process_output.y;
  float _814 = resonance_post_process_output.z;
