...
float4 main(
  ...
  float _265 = ResonanceScaleVignetteMask(exp2(_264));
  ...
  float _319 = resonance_scaled_lut_output.x;
  float _320 = resonance_scaled_lut_output.y;
  float _321 = resonance_scaled_lut_output.z;
  ...
  if (!ResonanceIsPsychoV()) {
    _418 = resonance_film_grain_output.x;
    _419 = resonance_film_grain_output.y;
    _420 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _460 = resonance_post_process_output.x;
  float _461 = resonance_post_process_output.y;
  float _462 = resonance_post_process_output.z;
