...
float4 main(
  ...
  float _671 = resonance_scaled_lut_output.x;
  float _672 = resonance_scaled_lut_output.y;
  float _673 = resonance_scaled_lut_output.z;
  ...
  _770 = resonance_film_grain_output.x;
  _771 = resonance_film_grain_output.y;
  _772 = resonance_film_grain_output.z;
  bool _775 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_775) {
    float _784 = _770 * (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _785 = _771 * (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _786 = _772 * (PostProcess_000.PostProcessConstant_Z_000[10].w);
    bool _787 = (_784 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_787) {
      float _789 = _784 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _790 = 1.0f - _789;
      float _791 = _790 * _790;
      float _792 = _791 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _793 = _792 + _784;
      _795 = _793;
    } else {
      _795 = _784;
    }
    bool _796 = (_785 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_796) {
      float _798 = _785 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _799 = 1.0f - _798;
      float _800 = _799 * _799;
      float _801 = _800 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _802 = _801 + _785;
      _804 = _802;
    } else {
      _804 = _785;
    }
    bool _805 = (_786 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_805) {
      float _807 = _786 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _808 = 1.0f - _807;
      float _809 = _808 * _808;
      float _810 = _809 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _811 = _810 + _786;
      _813 = _811;
    } else {
      _813 = _786;
    }
    float _814 = _795 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _815 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
    float _816 = log2(_814);
    float _817 = _816 * _815;
    float _818 = exp2(_817);
    float _819 = _818 + -1.0f;
    float _820 = _814 + -1.0f;
    float _821 = _819 / _820;
    bool _822 = !(_814 == 1.0f);
    float _823 = _821 + -1.0f;
    float _824 = _823 / _821;
    float _825 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _826 = _825 / _815;
    float _827 = select(_822, _824, _826);
    float _828 = _827 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _829 = _804 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _830 = log2(_829);
    float _831 = _830 * _815;
    float _832 = exp2(_831);
    float _833 = _832 + -1.0f;
    float _834 = _829 + -1.0f;
    float _835 = _833 / _834;
    bool _836 = !(_829 == 1.0f);
    float _837 = _835 + -1.0f;
    float _838 = _837 / _835;
    float _839 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _840 = _839 / _815;
    float _841 = select(_836, _838, _840);
    float _842 = _841 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _843 = _813 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _844 = log2(_843);
    float _845 = _844 * _815;
    float _846 = exp2(_845);
    float _847 = _846 + -1.0f;
    float _848 = _843 + -1.0f;
    ...
    float _854 = _853 / _815;
    float _855 = select(_850, _852, _854);
    float _856 = _855 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _857 = _828 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _858 = _842 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _859 = _856 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    _861 = _857;
    _862 = _858;
    _863 = _859;
  } else {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      float3(_770, _771, _772),
      float3(_861, _862, _863),
      false);
  _861 = resonance_post_process_output.x;
  _862 = resonance_post_process_output.y;
  _863 = resonance_post_process_output.z;
  float _864 = log2(_861);
  float _865 = log2(_862);
  float _866 = log2(_863);
  float _867 = _864 * 0.4166666567325592f;
  float _868 = _865 * 0.4166666567325592f;
  float _869 = _866 * 0.4166666567325592f;
  float _870 = exp2(_867);
  float _871 = exp2(_868);
  float _872 = exp2(_869);
  float _873 = _870 * 1.0549999475479126f;
  float _874 = _871 * 1.0549999475479126f;
  float _875 = _872 * 1.0549999475479126f;
  float _876 = _873 + -0.054999999701976776f;
  float _877 = _874 + -0.054999999701976776f;
  float _878 = _875 + -0.054999999701976776f;
  float _879 = _861 * 12.920000076293945f;
  float _880 = _862 * 12.920000076293945f;
  float _881 = _863 * 12.920000076293945f;
  bool _882 = (_861 <= 0.0031308000907301903f);
  bool _883 = (_862 <= 0.0031308000907301903f);
  bool _884 = (_863 <= 0.0031308000907301903f);
  float _885 = select(_882, _879, _876);
  float _886 = select(_883, _880, _877);
  float _887 = select(_884, _881, _878);
  float _888 = log2(_885);
  float _889 = log2(_886);
  float _890 = log2(_887);
  float _891 = floor(_888);
  float _892 = floor(_889);
  float _893 = floor(_890);
  float _894 = _891 + -6.0f;
  float _895 = _892 + -6.0f;
  float _896 = _893 + -5.0f;
  ...
  float _904 = select(_901, 0.0f, _898);
  float _905 = select(_902, 0.0f, _899);
  uint _906 = uint(SV_Position.x);
  uint _907 = uint(SV_Position.y);
  int _908 = _906 & 63;
  int _909 = _907 & 63;
  float4 _911 = t1.Load(int4(_908, _909, _699, 0));
  float4 _913 = t6.Load(int4(_908, _909, _699, 0));
  float _916 = _911.x * _903;
  float _917 = _913.x * _904;
  float _918 = _913.y * _905;
  float _919 = _916 + _885;
  float _920 = _917 + _886;
  float _921 = _918 + _887;
  SV_Target.x = _919;
  SV_Target.y = _920;
  SV_Target.z = _921;
  SV_Target.w = _137.w;
