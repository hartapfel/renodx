...
float4 main(
  ...
  if (!ResonanceIsPsychoV()) {
    float _819 = resonance_scaled_lut_output.x;
    ...
    _832 = select(_827, _829, _831);
    float _833 = resonance_scaled_lut_output.y;
    ...
    _845 = select(_840, _842, _844);
    float _846 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _859 = resonance_post_process_output.x;
  float _860 = resonance_post_process_output.y;
  float _861 = resonance_post_process_output.z;
