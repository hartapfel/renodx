...
float4 main(
  ...
  float _715 = resonance_scaled_lut_output.x;
  float _716 = resonance_scaled_lut_output.y;
  float _717 = resonance_scaled_lut_output.z;
  ...
  if (!ResonanceIsPsychoV()) {
    _814 = resonance_film_grain_output.x;
    _815 = resonance_film_grain_output.y;
    _816 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _856 = resonance_post_process_output.x;
  float _857 = resonance_post_process_output.y;
  float _858 = resonance_post_process_output.z;
