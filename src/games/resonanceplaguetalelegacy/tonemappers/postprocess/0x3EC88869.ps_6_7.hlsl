...
float4 main(
  ...
  float _918 = resonance_scaled_lut_output.x;
  float _919 = resonance_scaled_lut_output.y;
  float _920 = resonance_scaled_lut_output.z;
  ...
  _1017 = resonance_film_grain_output.x;
  _1018 = resonance_film_grain_output.y;
  _1019 = resonance_film_grain_output.z;
  bool _1022 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_1022) {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      false);
  _1108 = resonance_post_process_output.x;
  _1109 = resonance_post_process_output.y;
  _1110 = resonance_post_process_output.z;
