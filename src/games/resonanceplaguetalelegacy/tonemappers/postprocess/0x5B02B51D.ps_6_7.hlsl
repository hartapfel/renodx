...
float4 main(
  ...
  if (!ResonanceIsPsychoV()) {
    float _424 = resonance_scaled_lut_output.x;
    ...
    float _438 = resonance_scaled_lut_output.y;
    ...
    float _451 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _464 = resonance_post_process_output.x;
  float _465 = resonance_post_process_output.y;
  float _466 = resonance_post_process_output.z;
