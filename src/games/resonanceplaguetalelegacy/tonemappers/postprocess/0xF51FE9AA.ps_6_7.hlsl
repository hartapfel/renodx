...
float4 main(
  ...
  float _674 = resonance_scaled_lut_output.x;
  float _675 = resonance_scaled_lut_output.y;
  float _676 = resonance_scaled_lut_output.z;
  bool _679 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_679) {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      false);
  _766 = resonance_post_process_output.x;
  _767 = resonance_post_process_output.y;
  _768 = resonance_post_process_output.z;
