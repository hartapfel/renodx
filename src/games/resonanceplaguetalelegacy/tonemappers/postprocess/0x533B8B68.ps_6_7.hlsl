...
float4 main(
  ...
  float _58 = 0.5f - (PostProcess_000.PostProcessConstant_Z_000[19].x);
  float _59 = 0.5f - (PostProcess_000.PostProcessConstant_Z_000[19].y);
  float _60 = _58 + _51;
  float _61 = _59 + _52;
  float _62 = _60 * 2.0f;
  float _63 = _61 * 2.0f;
  float _64 = _62 + -1.0f;
  float _65 = _63 + -1.0f;
  float _69 = _65 * (Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[51].y);
  float _70 = abs(_64);
  float _71 = abs(_65);
  float _73 = (PostProcess_000.PostProcessConstant_Z_000[19].z) * 2.0f;
  float _74 = _73 + -1.0f;
  float _75 = _70 - _74;
  float _76 = _71 - _74;
  float _77 = saturate(_75);
  float _78 = saturate(_76);
  float _79 = _77 * (Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[51].x);
  float _80 = _79 * _64;
  float _81 = _69 * _78;
  float _82 = _80 * _80;
  float _83 = _81 * _81;
  ...
  float _90 = _88 * 2.0f;
  float _91 = _90 + -1.0f;
  float _92 = _89 * 1.125f;
  float _93 = _92 + -0.5625f;
  float _94 = _91 * _91;
  float _95 = _93 * _93;
  float _96 = _94 + _95;
  float _97 = sqrt(_96);
  float _98 = _97 * 0.8715755343437195f;
  float _99 = _98 * _98;
  float _100 = _99 + -0.15000000596046448f;
  float _101 = _100 * 1.8181819915771484f;
  float _102 = saturate(_101);
  float _103 = _102 * 2.0f;
  float _104 = 3.0f - _103;
  float _105 = (PostProcess_000.PostProcessConstant_Z_000[2].w) * _85;
  float _106 = _102 * _102;
  float _107 = _106 * _105;
  float _108 = _107 * _99;
  ...
  float _113 = _112 + _52;
  float _114 = _51 - _111;
  float _115 = _37.x * 0.010840999893844128f;
  float _116 = _115 + _51;
  ...
  float _122 = max(_109, _121);
  float4 _125 = t0.SampleLevel(s0, float2(_117, _113), _122);
  float4 _127 = t0.SampleLevel(s0, float2(_114, _119), _122);
  ...
  float _281 = resonance_scaled_lut_output.x;
  float _282 = resonance_scaled_lut_output.y;
  float _283 = resonance_scaled_lut_output.z;
  ...
  if (!ResonanceIsPsychoV()) {
    _380 = resonance_film_grain_output.x;
    _381 = resonance_film_grain_output.y;
    _382 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _422 = resonance_post_process_output.x;
  float _423 = resonance_post_process_output.y;
  float _424 = resonance_post_process_output.z;
