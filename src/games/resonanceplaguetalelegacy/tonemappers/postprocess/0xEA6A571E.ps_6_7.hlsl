...
float4 main(
  ...
  float _899 = ResonanceScaleVignetteMask(exp2(_898));
  ...
  if (!ResonanceIsPsychoV()) {
    float _955 = resonance_scaled_lut_output.x;
    ...
    _968 = select(_963, _965, _967);
    float _969 = resonance_scaled_lut_output.y;
    ...
    _981 = select(_976, _978, _980);
    float _982 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _995 = resonance_post_process_output.x;
  float _996 = resonance_post_process_output.y;
  float _997 = resonance_post_process_output.z;
