...
float4 main(
  ...
  float _677 = resonance_scaled_lut_output.x;
  float _678 = resonance_scaled_lut_output.y;
  float _679 = resonance_scaled_lut_output.z;
  ...
  if (!ResonanceIsPsychoV()) {
    _776 = resonance_film_grain_output.x;
    _777 = resonance_film_grain_output.y;
    _778 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _818 = resonance_post_process_output.x;
  float _819 = resonance_post_process_output.y;
  float _820 = resonance_post_process_output.z;
