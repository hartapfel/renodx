...
float4 main(
  ...
  if (!ResonanceIsPsychoV()) {
    float _676 = resonance_scaled_lut_output.x;
    ...
    _689 = select(_684, _686, _688);
    float _690 = resonance_scaled_lut_output.y;
    ...
    _702 = select(_697, _699, _701);
    float _703 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _716 = resonance_post_process_output.x;
  float _717 = resonance_post_process_output.y;
  float _718 = resonance_post_process_output.z;
