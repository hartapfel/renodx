...
float4 main(
  ...
  float _668 = resonance_scaled_lut_output.x;
  float _669 = resonance_scaled_lut_output.y;
  float _670 = resonance_scaled_lut_output.z;
  bool _673 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_673) {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      false);
  _760 = resonance_post_process_output.x;
  _761 = resonance_post_process_output.y;
  _762 = resonance_post_process_output.z;
