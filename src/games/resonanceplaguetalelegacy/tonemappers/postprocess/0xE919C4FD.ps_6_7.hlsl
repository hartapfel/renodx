...
float4 main(
  ...
  bool _562 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_562) {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      false);
  _649 = resonance_post_process_output.x;
  _650 = resonance_post_process_output.y;
  _651 = resonance_post_process_output.z;
