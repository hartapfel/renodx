...
float4 main(
  ...
  float _896 = ResonanceScaleVignetteMask(exp2(_895));
  ...
  float _950 = resonance_scaled_lut_output.x;
  float _951 = resonance_scaled_lut_output.y;
  float _952 = resonance_scaled_lut_output.z;
  ...
  if (!ResonanceIsPsychoV()) {
    ...
    float _1054 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
    float _1055 = log2(_1049);
    float _1056 = _1054 * _1055;
    float _1057 = exp2(_1056);
    float _1058 = _1057 + -1.0f;
    float _1059 = _1049 + -1.0f;
    float _1060 = _1058 / _1059;
    bool _1061 = !(_1049 == 1.0f);
    ...
    _1066 = select(_1061, _1063, _1065);
    float _1067 = log2(_1050);
    float _1068 = _1067 * _1054;
    float _1069 = exp2(_1068);
    float _1070 = _1069 + -1.0f;
    float _1071 = _1050 + -1.0f;
    float _1072 = _1070 / _1071;
    bool _1073 = !(_1050 == 1.0f);
    float _1074 = _1072 + -1.0f;
    float _1075 = _1074 / _1072;
    float _1076 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _1077 = _1076 / _1054;
    _1078 = select(_1073, _1075, _1077);
    float _1079 = log2(_1051);
    float _1080 = _1079 * _1054;
    float _1081 = exp2(_1080);
    float _1082 = _1081 + -1.0f;
    float _1083 = _1051 + -1.0f;
    float _1084 = _1082 / _1083;
    bool _1085 = !(_1051 == 1.0f);
    float _1086 = _1084 + -1.0f;
    float _1087 = _1086 / _1084;
    float _1088 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _1089 = _1088 / _1054;
    _1090 = select(_1085, _1087, _1089);
  } else {
    _1066 = 0.f;
    _1078 = 0.f;
    _1090 = 0.f;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      float3(_1066, _1078, _1090),
      true);
  float _1091 = resonance_post_process_output.x;
  float _1092 = resonance_post_process_output.y;
  float _1093 = resonance_post_process_output.z;
  float _1094 = log2(_1091);
  float _1095 = log2(_1092);
  float _1096 = log2(_1093);
  float _1097 = _1094 * 0.4166666567325592f;
  float _1098 = _1095 * 0.4166666567325592f;
  float _1099 = _1096 * 0.4166666567325592f;
  ...
  float _1105 = _1102 * 1.0549999475479126f;
  float _1106 = _1103 + -0.054999999701976776f;
  float _1107 = _1104 + -0.054999999701976776f;
  float _1108 = _1105 + -0.054999999701976776f;
  float _1109 = _1091 * 12.920000076293945f;
  float _1110 = _1092 * 12.920000076293945f;
  float _1111 = _1093 * 12.920000076293945f;
  bool _1112 = (_1091 <= 0.0031308000907301903f);
  bool _1113 = (_1092 <= 0.0031308000907301903f);
  bool _1114 = (_1093 <= 0.0031308000907301903f);
  float _1115 = select(_1112, _1109, _1106);
  float _1116 = select(_1113, _1110, _1107);
  float _1117 = select(_1114, _1111, _1108);
  float _1118 = log2(_1115);
  float _1119 = log2(_1116);
  float _1120 = log2(_1117);
  float _1121 = floor(_1118);
  float _1122 = floor(_1119);
  float _1123 = floor(_1120);
  float _1124 = _1121 + -6.0f;
  float _1125 = _1122 + -6.0f;
  float _1126 = _1123 + -5.0f;
  float _1127 = exp2(_1124);
  float _1128 = exp2(_1125);
  float _1129 = exp2(_1126);
  bool _1130 = (_1115 <= 0.0f);
  bool _1131 = (_1116 <= 0.0f);
  bool _1132 = (_1117 <= 0.0f);
  float _1133 = select(_1130, 0.0f, _1127);
  float _1134 = select(_1131, 0.0f, _1128);
  float _1135 = select(_1132, 0.0f, _1129);
  uint _1136 = uint(SV_Position.x);
  uint _1137 = uint(SV_Position.y);
  int _1138 = _1136 & 63;
  int _1139 = _1137 & 63;
  float4 _1141 = t1.Load(int4(_1138, _1139, _978, 0));
  float4 _1143 = t6.Load(int4(_1138, _1139, _978, 0));
  float _1146 = _1141.x * _1133;
  float _1147 = _1143.x * _1134;
  float _1148 = _1143.y * _1135;
  float _1149 = _1146 + _1115;
  float _1150 = _1147 + _1116;
  float _1151 = _1148 + _1117;
  SV_Target.x = _1149;
  SV_Target.y = _1150;
  SV_Target.z = _1151;
  SV_Target.w = _380;
