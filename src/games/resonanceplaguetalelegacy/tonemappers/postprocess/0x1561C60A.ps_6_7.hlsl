...
float4 main(
  ...
  float _709 = resonance_scaled_lut_output.x;
  float _710 = resonance_scaled_lut_output.y;
  float _711 = resonance_scaled_lut_output.z;
  ...
  if (!ResonanceIsPsychoV()) {
    _808 = resonance_film_grain_output.x;
    _809 = resonance_film_grain_output.y;
    _810 = resonance_film_grain_output.z;
    float _813 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
    float _814 = log2(_808);
    float _815 = _813 * _814;
    float _816 = exp2(_815);
    float _817 = _816 + -1.0f;
    float _818 = _808 + -1.0f;
    ...
    _825 = select(_820, _822, _824);
    float _826 = log2(_809);
    float _827 = _826 * _813;
    float _828 = exp2(_827);
    float _829 = _828 + -1.0f;
    float _830 = _809 + -1.0f;
    float _831 = _829 / _830;
    bool _832 = !(_809 == 1.0f);
    float _833 = _831 + -1.0f;
    float _834 = _833 / _831;
    float _835 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _836 = _835 / _813;
    _837 = select(_832, _834, _836);
    float _838 = log2(_810);
    float _839 = _838 * _813;
    float _840 = exp2(_839);
    float _841 = _840 + -1.0f;
    float _842 = _810 + -1.0f;
    float _843 = _841 / _842;
    bool _844 = !(_810 == 1.0f);
    float _845 = _843 + -1.0f;
    float _846 = _845 / _843;
    float _847 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _848 = _847 / _813;
    _849 = select(_844, _846, _848);
  } else {
    _825 = 0.f;
    _837 = 0.f;
    _849 = 0.f;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      float3(_825, _837, _849),
      true);
  float _850 = resonance_post_process_output.x;
  float _851 = resonance_post_process_output.y;
  float _852 = resonance_post_process_output.z;
  float _853 = log2(_850);
  float _854 = log2(_851);
  float _855 = log2(_852);
  float _856 = _853 * 0.4166666567325592f;
  float _857 = _854 * 0.4166666567325592f;
  float _858 = _855 * 0.4166666567325592f;
  float _859 = exp2(_856);
  float _860 = exp2(_857);
  float _861 = exp2(_858);
  float _862 = _859 * 1.0549999475479126f;
  float _863 = _860 * 1.0549999475479126f;
  float _864 = _861 * 1.0549999475479126f;
  float _865 = _862 + -0.054999999701976776f;
  float _866 = _863 + -0.054999999701976776f;
  float _867 = _864 + -0.054999999701976776f;
  float _868 = _850 * 12.920000076293945f;
  float _869 = _851 * 12.920000076293945f;
  float _870 = _852 * 12.920000076293945f;
  bool _871 = (_850 <= 0.0031308000907301903f);
  bool _872 = (_851 <= 0.0031308000907301903f);
  bool _873 = (_852 <= 0.0031308000907301903f);
  float _874 = select(_871, _868, _865);
  float _875 = select(_872, _869, _866);
  float _876 = select(_873, _870, _867);
  float _877 = log2(_874);
  float _878 = log2(_875);
  float _879 = log2(_876);
  float _880 = floor(_877);
  float _881 = floor(_878);
  float _882 = floor(_879);
  float _883 = _880 + -6.0f;
  float _884 = _881 + -6.0f;
  float _885 = _882 + -5.0f;
  float _886 = exp2(_883);
  float _887 = exp2(_884);
  float _888 = exp2(_885);
  bool _889 = (_874 <= 0.0f);
  bool _890 = (_875 <= 0.0f);
  bool _891 = (_876 <= 0.0f);
  float _892 = select(_889, 0.0f, _886);
  float _893 = select(_890, 0.0f, _887);
  float _894 = select(_891, 0.0f, _888);
  uint _895 = uint(SV_Position.x);
  uint _896 = uint(SV_Position.y);
  int _897 = _895 & 63;
  int _898 = _896 & 63;
  float4 _900 = t1.Load(int4(_897, _898, _737, 0));
  float4 _902 = t6.Load(int4(_897, _898, _737, 0));
  float _905 = _900.x * _892;
  float _906 = _902.x * _893;
  float _907 = _902.y * _894;
  float _908 = _905 + _874;
  float _909 = _906 + _875;
  float _910 = _907 + _876;
  SV_Target.x = _908;
  SV_Target.y = _909;
  SV_Target.z = _910;
  SV_Target.w = _137.w;
