...
float4 main(
  ...
  float _817 = resonance_scaled_lut_output.x;
  float _818 = resonance_scaled_lut_output.y;
  float _819 = resonance_scaled_lut_output.z;
  bool _822 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_822) {
    float _832 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _817;
    float _833 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _818;
    float _834 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _819;
    bool _835 = (_832 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_835) {
      float _837 = _832 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _838 = 1.0f - _837;
      float _839 = _838 * _838;
      float _840 = _839 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _841 = _840 + _832;
      _843 = _841;
    } else {
      _843 = _832;
    }
    bool _844 = (_833 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_844) {
      float _846 = _833 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _847 = 1.0f - _846;
      float _848 = _847 * _847;
      float _849 = _848 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _850 = _849 + _833;
      _852 = _850;
    } else {
      _852 = _833;
    }
    bool _853 = (_834 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_853) {
      float _855 = _834 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _856 = 1.0f - _855;
      float _857 = _856 * _856;
      float _858 = _857 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _859 = _858 + _834;
      _861 = _859;
    } else {
      _861 = _834;
    }
    float _862 = _843 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _863 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
    float _864 = log2(_862);
    float _865 = _864 * _863;
    float _866 = exp2(_865);
    float _867 = _866 + -1.0f;
    float _868 = _862 + -1.0f;
    float _869 = _867 / _868;
    bool _870 = !(_862 == 1.0f);
    float _871 = _869 + -1.0f;
    float _872 = _871 / _869;
    float _873 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _874 = _873 / _863;
    float _875 = select(_870, _872, _874);
    float _876 = _875 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _877 = _852 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _878 = log2(_877);
    float _879 = _878 * _863;
    float _880 = exp2(_879);
    float _881 = _880 + -1.0f;
    float _882 = _877 + -1.0f;
    float _883 = _881 / _882;
    bool _884 = !(_877 == 1.0f);
    float _885 = _883 + -1.0f;
    float _886 = _885 / _883;
    float _887 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _888 = _887 / _863;
    float _889 = select(_884, _886, _888);
    float _890 = _889 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _891 = _861 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _892 = log2(_891);
    float _893 = _892 * _863;
    float _894 = exp2(_893);
    float _895 = _894 + -1.0f;
    float _896 = _891 + -1.0f;
    float _897 = _895 / _896;
    bool _898 = !(_891 == 1.0f);
    float _899 = _897 + -1.0f;
    float _900 = _899 / _897;
    float _901 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _902 = _901 / _863;
    float _903 = select(_898, _900, _902);
    float _904 = _903 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _905 = _876 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _906 = _890 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _907 = _904 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    _909 = _905;
    _910 = _906;
    _911 = _907;
  } else {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      float3(_909, _910, _911),
      false);
  _909 = resonance_post_process_output.x;
  _910 = resonance_post_process_output.y;
  _911 = resonance_post_process_output.z;
  float _912 = log2(_909);
  float _913 = log2(_910);
  float _914 = log2(_911);
  float _915 = _912 * 0.4166666567325592f;
  float _916 = _913 * 0.4166666567325592f;
  float _917 = _914 * 0.4166666567325592f;
  float _918 = exp2(_915);
  float _919 = exp2(_916);
  float _920 = exp2(_917);
  float _921 = _918 * 1.0549999475479126f;
  float _922 = _919 * 1.0549999475479126f;
  float _923 = _920 * 1.0549999475479126f;
  float _924 = _921 + -0.054999999701976776f;
  float _925 = _922 + -0.054999999701976776f;
  float _926 = _923 + -0.054999999701976776f;
  float _927 = _909 * 12.920000076293945f;
  float _928 = _910 * 12.920000076293945f;
  float _929 = _911 * 12.920000076293945f;
  bool _930 = (_909 <= 0.0031308000907301903f);
  bool _931 = (_910 <= 0.0031308000907301903f);
  bool _932 = (_911 <= 0.0031308000907301903f);
  float _933 = select(_930, _927, _924);
  float _934 = select(_931, _928, _925);
  float _935 = select(_932, _929, _926);
  float _936 = log2(_933);
  float _937 = log2(_934);
  float _938 = log2(_935);
  float _939 = floor(_936);
  float _940 = floor(_937);
  float _941 = floor(_938);
  float _942 = _939 + -6.0f;
  float _943 = _940 + -6.0f;
  float _944 = _941 + -5.0f;
  ...
  bool _949 = (_934 <= 0.0f);
  bool _950 = (_935 <= 0.0f);
  float _951 = select(_948, 0.0f, _945);
  float _952 = select(_949, 0.0f, _946);
  float _953 = select(_950, 0.0f, _947);
  int _956 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  uint _957 = uint(SV_Position.x);
  uint _958 = uint(SV_Position.y);
  int _959 = _957 & 63;
  int _960 = _958 & 63;
  float4 _962 = t1.Load(int4(_959, _960, _956, 0));
  float4 _965 = t6.Load(int4(_959, _960, _956, 0));
  float _968 = _962.x * _951;
  float _969 = _965.x * _952;
  float _970 = _965.y * _953;
  float _971 = _968 + _933;
  float _972 = _969 + _934;
  float _973 = _970 + _935;
  SV_Target.x = _971;
  SV_Target.y = _972;
  SV_Target.z = _973;
  SV_Target.w = _372;
