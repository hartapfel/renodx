...
float4 main(
  ...
  if (!ResonanceIsPsychoV()) {
    float _280 = resonance_scaled_lut_output.x;
    ...
    _293 = select(_288, _290, _292);
    float _294 = resonance_scaled_lut_output.y;
    ...
    _306 = select(_301, _303, _305);
    float _307 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _320 = resonance_post_process_output.x;
  float _321 = resonance_post_process_output.y;
  float _322 = resonance_post_process_output.z;
