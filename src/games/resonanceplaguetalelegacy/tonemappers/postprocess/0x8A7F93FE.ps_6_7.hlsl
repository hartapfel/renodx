...
float4 main(
  ...
  float _506 = ResonanceScaleVignetteMask(exp2(_505));
  ...
  float _560 = resonance_scaled_lut_output.x;
  float _561 = resonance_scaled_lut_output.y;
  float _562 = resonance_scaled_lut_output.z;
  ...
  if (!ResonanceIsPsychoV()) {
    ...
    float _668 = _667 + -1.0f;
    float _669 = _659 + -1.0f;
    float _670 = _668 / _669;
    bool _671 = !(_659 == 1.0f);
    float _672 = _670 + -1.0f;
    float _673 = _672 / _670;
    float _674 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _675 = _674 / _664;
    _676 = select(_671, _673, _675);
    float _677 = log2(_660);
    float _678 = _677 * _664;
    float _679 = exp2(_678);
    float _680 = _679 + -1.0f;
    float _681 = _660 + -1.0f;
    float _682 = _680 / _681;
    bool _683 = !(_660 == 1.0f);
    float _684 = _682 + -1.0f;
    float _685 = _684 / _682;
    float _686 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _687 = _686 / _664;
    _688 = select(_683, _685, _687);
    float _689 = log2(_661);
    float _690 = _689 * _664;
    float _691 = exp2(_690);
    float _692 = _691 + -1.0f;
    float _693 = _661 + -1.0f;
    float _694 = _692 / _693;
    bool _695 = !(_661 == 1.0f);
    float _696 = _694 + -1.0f;
    float _697 = _696 / _694;
    float _698 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _699 = _698 / _664;
    _700 = select(_695, _697, _699);
  } else {
    _676 = 0.f;
    _688 = 0.f;
    _700 = 0.f;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      float3(_676, _688, _700),
      true);
  float _701 = resonance_post_process_output.x;
  float _702 = resonance_post_process_output.y;
  float _703 = resonance_post_process_output.z;
  float _704 = log2(_701);
  float _705 = log2(_702);
  float _706 = log2(_703);
  float _707 = _704 * 0.4166666567325592f;
  float _708 = _705 * 0.4166666567325592f;
  float _709 = _706 * 0.4166666567325592f;
  ...
  float _715 = _712 * 1.0549999475479126f;
  float _716 = _713 + -0.054999999701976776f;
  float _717 = _714 + -0.054999999701976776f;
  float _718 = _715 + -0.054999999701976776f;
  float _719 = _701 * 12.920000076293945f;
  float _720 = _702 * 12.920000076293945f;
  float _721 = _703 * 12.920000076293945f;
  bool _722 = (_701 <= 0.0031308000907301903f);
  bool _723 = (_702 <= 0.0031308000907301903f);
  bool _724 = (_703 <= 0.0031308000907301903f);
  float _725 = select(_722, _719, _716);
  float _726 = select(_723, _720, _717);
  float _727 = select(_724, _721, _718);
  float _728 = log2(_725);
  float _729 = log2(_726);
  float _730 = log2(_727);
  float _731 = floor(_728);
  float _732 = floor(_729);
  float _733 = floor(_730);
  float _734 = _731 + -6.0f;
  float _735 = _732 + -6.0f;
  float _736 = _733 + -5.0f;
  ...
  bool _741 = (_726 <= 0.0f);
  bool _742 = (_727 <= 0.0f);
  float _743 = select(_740, 0.0f, _737);
  float _744 = select(_741, 0.0f, _738);
  float _745 = select(_742, 0.0f, _739);
  uint _746 = uint(SV_Position.x);
  uint _747 = uint(SV_Position.y);
  int _748 = _746 & 63;
  int _749 = _747 & 63;
  float4 _751 = t1.Load(int4(_748, _749, _588, 0));
  float4 _753 = t2.Load(int4(_748, _749, _588, 0));
  float _756 = _751.x * _743;
  float _757 = _753.x * _744;
  float _758 = _753.y * _745;
  float _759 = _756 + _725;
  float _760 = _757 + _726;
  float _761 = _758 + _727;
  SV_Target.x = _759;
  SV_Target.y = _760;
  SV_Target.z = _761;
  SV_Target.w = _372;
