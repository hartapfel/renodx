...
float4 main(
  ...
  float _893 = ResonanceScaleVignetteMask(exp2(_892));
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      float3(_940, _941, _942) * User_000.UserConstant_Z_000[4].rgb,
  ...
  if (!ResonanceIsPsychoV()) {
    ...
    _962 = select(_957, _959, _961);
    float _963 = resonance_scaled_lut_output.y;
    float _964 = log2(_963);
    float _965 = _964 * _950;
    float _966 = exp2(_965);
    float _967 = _966 + -1.0f;
    float _968 = _963 + -1.0f;
    float _969 = _967 / _968;
    bool _970 = !(_963 == 1.0f);
    float _971 = _969 + -1.0f;
    float _972 = _971 / _969;
    float _973 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _974 = _973 / _950;
    _975 = select(_970, _972, _974);
    float _976 = resonance_scaled_lut_output.z;
    float _977 = log2(_976);
    float _978 = _977 * _950;
    float _979 = exp2(_978);
    float _980 = _979 + -1.0f;
    float _981 = _976 + -1.0f;
    float _982 = _980 / _981;
    bool _983 = !(_976 == 1.0f);
    float _984 = _982 + -1.0f;
    float _985 = _984 / _982;
    float _986 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _987 = _986 / _950;
    _988 = select(_983, _985, _987);
  } else {
    _962 = 0.f;
    _975 = 0.f;
    _988 = 0.f;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      float3(_962, _975, _988),
      true);
  float _989 = resonance_post_process_output.x;
  float _990 = resonance_post_process_output.y;
  float _991 = resonance_post_process_output.z;
  float _992 = log2(_989);
  float _993 = log2(_990);
  float _994 = log2(_991);
  float _995 = _992 * 0.4166666567325592f;
  float _996 = _993 * 0.4166666567325592f;
  float _997 = _994 * 0.4166666567325592f;
  float _998 = exp2(_995);
  float _999 = exp2(_996);
  float _1000 = exp2(_997);
  float _1001 = _998 * 1.0549999475479126f;
  float _1002 = _999 * 1.0549999475479126f;
  float _1003 = _1000 * 1.0549999475479126f;
  float _1004 = _1001 + -0.054999999701976776f;
  float _1005 = _1002 + -0.054999999701976776f;
  float _1006 = _1003 + -0.054999999701976776f;
  float _1007 = _989 * 12.920000076293945f;
  float _1008 = _990 * 12.920000076293945f;
  float _1009 = _991 * 12.920000076293945f;
  bool _1010 = (_989 <= 0.0031308000907301903f);
  bool _1011 = (_990 <= 0.0031308000907301903f);
  bool _1012 = (_991 <= 0.0031308000907301903f);
  float _1013 = select(_1010, _1007, _1004);
  float _1014 = select(_1011, _1008, _1005);
  float _1015 = select(_1012, _1009, _1006);
  float _1016 = log2(_1013);
  float _1017 = log2(_1014);
  float _1018 = log2(_1015);
  float _1019 = floor(_1016);
  float _1020 = floor(_1017);
  float _1021 = floor(_1018);
  float _1022 = _1019 + -6.0f;
  float _1023 = _1020 + -6.0f;
  float _1024 = _1021 + -5.0f;
  float _1025 = exp2(_1022);
  float _1026 = exp2(_1023);
  float _1027 = exp2(_1024);
  bool _1028 = (_1013 <= 0.0f);
  bool _1029 = (_1014 <= 0.0f);
  bool _1030 = (_1015 <= 0.0f);
  float _1031 = select(_1028, 0.0f, _1025);
  float _1032 = select(_1029, 0.0f, _1026);
  float _1033 = select(_1030, 0.0f, _1027);
  int _1036 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  uint _1037 = uint(SV_Position.x);
  uint _1038 = uint(SV_Position.y);
  int _1039 = _1037 & 63;
  int _1040 = _1038 & 63;
  float4 _1042 = t1.Load(int4(_1039, _1040, _1036, 0));
  float4 _1045 = t6.Load(int4(_1039, _1040, _1036, 0));
  float _1048 = _1042.x * _1031;
  float _1049 = _1045.x * _1032;
  float _1050 = _1045.y * _1033;
  float _1051 = _1048 + _1013;
  float _1052 = _1049 + _1014;
  float _1053 = _1050 + _1015;
  SV_Target.x = _1051;
  SV_Target.y = _1052;
  SV_Target.z = _1053;
  SV_Target.w = _377;
