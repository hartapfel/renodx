...
float4 main(
  ...
  if (!ResonanceIsPsychoV()) {
    float _521 = resonance_scaled_lut_output.x;
    ...
    _534 = select(_529, _531, _533);
    float _535 = resonance_scaled_lut_output.y;
    ...
    _547 = select(_542, _544, _546);
    float _548 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _561 = resonance_post_process_output.x;
  float _562 = resonance_post_process_output.y;
  float _563 = resonance_post_process_output.z;
