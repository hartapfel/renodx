...
float4 main(
  ...
  float _262 = ResonanceScaleVignetteMask(exp2(_261));
  ...
  if (!ResonanceIsPsychoV()) {
    float _318 = resonance_scaled_lut_output.x;
    ...
    _331 = select(_326, _328, _330);
    float _332 = resonance_scaled_lut_output.y;
    ...
    _344 = select(_339, _341, _343);
    float _345 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _358 = resonance_post_process_output.x;
  float _359 = resonance_post_process_output.y;
  float _360 = resonance_post_process_output.z;
