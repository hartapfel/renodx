...
float4 main(
  ...
  float3 renodx_chromatic_aberration_input = ResonanceSelectChromaticAberrationInput(
      float3(_134, _135, _136),
      max(_131.rgb, 0.f.xxx),
      float2(_53, _54),
      t0,
      s0,
      _124);
  _134 = renodx_chromatic_aberration_input.x;
  _135 = renodx_chromatic_aberration_input.y;
  _136 = renodx_chromatic_aberration_input.z;
  ...
  float _562 = ResonanceScaleVignetteMask(exp2(_561));
  ...
  if (!ResonanceIsPsychoV()) {
    float _618 = resonance_scaled_lut_output.x;
    ...
    _631 = select(_626, _628, _630);
    float _632 = resonance_scaled_lut_output.y;
    ...
    _644 = select(_639, _641, _643);
    float _645 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _658 = resonance_post_process_output.x;
  float _659 = resonance_post_process_output.y;
  float _660 = resonance_post_process_output.z;
