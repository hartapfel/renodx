...
float4 main(
  ...
  if (!ResonanceIsPsychoV()) {
    float _857 = resonance_scaled_lut_output.x;
    ...
    _870 = select(_865, _867, _869);
    float _871 = resonance_scaled_lut_output.y;
    ...
    _883 = select(_878, _880, _882);
    float _884 = resonance_scaled_lut_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _897 = resonance_post_process_output.x;
  float _898 = resonance_post_process_output.y;
  float _899 = resonance_post_process_output.z;
