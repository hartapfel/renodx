...
float4 main(
  ...
  bool _813 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_813) {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      false);
  _899 = resonance_post_process_output.x;
  _900 = resonance_post_process_output.y;
  _901 = resonance_post_process_output.z;
