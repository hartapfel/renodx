...
float4 main(
  ...
  bool _423 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_423) {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      false);
  _509 = resonance_post_process_output.x;
  _510 = resonance_post_process_output.y;
  _511 = resonance_post_process_output.z;
