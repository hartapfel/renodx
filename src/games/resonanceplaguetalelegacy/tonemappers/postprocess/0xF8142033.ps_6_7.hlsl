...
float4 main(
  ...
  float _866 = (Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[87].y) * 335.718017578125f;
  float _867 = _857.x * _866;
  float _868 = _867 * _851;
  float _869 = _868 * (PostProcess_000.PostProcessConstant_Z_000[14].x);
  float _870 = _867 * _852;
  float _871 = _870 * (PostProcess_000.PostProcessConstant_Z_000[14].y);
  float _872 = _867 * _853;
  float _873 = _872 * (PostProcess_000.PostProcessConstant_Z_000[14].z);
  float _874 = _869 + 1.0f;
  float _875 = _871 + 1.0f;
  ...
  float _884 = _881 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float _885 = _882 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float _886 = _883 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float4 _889 = t3.Sample(s3, float3(_884, _885, _886));
  float _893 = _889.x * 13.450128555297852f;
  float _894 = _889.y * 13.450128555297852f;
  float _895 = _889.z * 13.450128555297852f;
  ...
  float _902 = _899 * 0.0029786902014166117f;
  float _903 = _900 * 0.0029786902014166117f;
  float _904 = _901 * 0.0029786902014166117f;
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      float3(_869 * 0.0029786902014166117f, _871 * 0.0029786902014166117f, _873 * 0.0029786902014166117f),
      float3(_902 * (User_000.UserConstant_Z_000[4].x), _903 * (User_000.UserConstant_Z_000[4].y), _904 * (User_000.UserConstant_Z_000[4].z)),
  ...
  float _909 = resonance_scaled_lut_output.x;
  float _910 = resonance_scaled_lut_output.y;
  float _911 = resonance_scaled_lut_output.z;
  bool _914 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_914) {
    float _924 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _909;
    float _925 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _910;
    float _926 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _911;
    bool _927 = (_924 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_927) {
      float _929 = _924 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _930 = 1.0f - _929;
      float _931 = _930 * _930;
      float _932 = _931 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _933 = _932 + _924;
      _935 = _933;
    } else {
      _935 = _924;
    }
    bool _936 = (_925 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_936) {
      float _938 = _925 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _939 = 1.0f - _938;
      float _940 = _939 * _939;
      float _941 = _940 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _942 = _941 + _925;
      _944 = _942;
    } else {
      _944 = _925;
    }
    bool _945 = (_926 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_945) {
      float _947 = _926 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _948 = 1.0f - _947;
      float _949 = _948 * _948;
      float _950 = _949 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _951 = _950 + _926;
      _953 = _951;
    } else {
      _953 = _926;
    }
    float _954 = _935 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _955 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
    float _956 = log2(_954);
    float _957 = _956 * _955;
    float _958 = exp2(_957);
    float _959 = _958 + -1.0f;
    float _960 = _954 + -1.0f;
    float _961 = _959 / _960;
    bool _962 = !(_954 == 1.0f);
    float _963 = _961 + -1.0f;
    float _964 = _963 / _961;
    float _965 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _966 = _965 / _955;
    float _967 = select(_962, _964, _966);
    float _968 = _967 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _969 = _944 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _970 = log2(_969);
    float _971 = _970 * _955;
    ...
    float _980 = _979 / _955;
    float _981 = select(_976, _978, _980);
    float _982 = _981 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _983 = _953 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _984 = log2(_983);
    float _985 = _984 * _955;
    float _986 = exp2(_985);
    float _987 = _986 + -1.0f;
    float _988 = _983 + -1.0f;
    float _989 = _987 / _988;
    bool _990 = !(_983 == 1.0f);
    float _991 = _989 + -1.0f;
    float _992 = _991 / _989;
    float _993 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _994 = _993 / _955;
    float _995 = select(_990, _992, _994);
    float _996 = _995 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _997 = _968 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _998 = _982 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _999 = _996 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    _1001 = _997;
    _1002 = _998;
    _1003 = _999;
  } else {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      float3(_1001, _1002, _1003),
      false);
  _1001 = resonance_post_process_output.x;
  _1002 = resonance_post_process_output.y;
  _1003 = resonance_post_process_output.z;
  float _1004 = log2(_1001);
  float _1005 = log2(_1002);
  float _1006 = log2(_1003);
  float _1007 = _1004 * 0.4166666567325592f;
  float _1008 = _1005 * 0.4166666567325592f;
  float _1009 = _1006 * 0.4166666567325592f;
  float _1010 = exp2(_1007);
  float _1011 = exp2(_1008);
  float _1012 = exp2(_1009);
  float _1013 = _1010 * 1.0549999475479126f;
  float _1014 = _1011 * 1.0549999475479126f;
  float _1015 = _1012 * 1.0549999475479126f;
  float _1016 = _1013 + -0.054999999701976776f;
  float _1017 = _1014 + -0.054999999701976776f;
  float _1018 = _1015 + -0.054999999701976776f;
  float _1019 = _1001 * 12.920000076293945f;
  float _1020 = _1002 * 12.920000076293945f;
  float _1021 = _1003 * 12.920000076293945f;
  bool _1022 = (_1001 <= 0.0031308000907301903f);
  bool _1023 = (_1002 <= 0.0031308000907301903f);
  bool _1024 = (_1003 <= 0.0031308000907301903f);
  float _1025 = select(_1022, _1019, _1016);
  float _1026 = select(_1023, _1020, _1017);
  float _1027 = select(_1024, _1021, _1018);
  float _1028 = log2(_1025);
  float _1029 = log2(_1026);
  float _1030 = log2(_1027);
  float _1031 = floor(_1028);
  float _1032 = floor(_1029);
  float _1033 = floor(_1030);
  float _1034 = _1031 + -6.0f;
  float _1035 = _1032 + -6.0f;
  float _1036 = _1033 + -5.0f;
  float _1037 = exp2(_1034);
  float _1038 = exp2(_1035);
  float _1039 = exp2(_1036);
  bool _1040 = (_1025 <= 0.0f);
  bool _1041 = (_1026 <= 0.0f);
  bool _1042 = (_1027 <= 0.0f);
  float _1043 = select(_1040, 0.0f, _1037);
  float _1044 = select(_1041, 0.0f, _1038);
  float _1045 = select(_1042, 0.0f, _1039);
  int _1048 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  uint _1049 = uint(SV_Position.x);
  uint _1050 = uint(SV_Position.y);
  int _1051 = _1049 & 63;
  int _1052 = _1050 & 63;
  float4 _1054 = t1.Load(int4(_1051, _1052, _1048, 0));
  float4 _1057 = t6.Load(int4(_1051, _1052, _1048, 0));
  float _1060 = _1054.x * _1043;
  float _1061 = _1057.x * _1044;
  float _1062 = _1057.y * _1045;
  float _1063 = _1060 + _1025;
  float _1064 = _1061 + _1026;
  float _1065 = _1062 + _1027;
  SV_Target.x = _1063;
  SV_Target.y = _1064;
  SV_Target.z = _1065;
  SV_Target.w = _377;
