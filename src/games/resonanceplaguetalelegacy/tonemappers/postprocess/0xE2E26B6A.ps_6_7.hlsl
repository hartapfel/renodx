...
float4 main(
  ...
  float _801 = ResonanceScaleVignetteMask(exp2(_800));
  ...
  float _855 = resonance_scaled_lut_output.x;
  float _856 = resonance_scaled_lut_output.y;
  float _857 = resonance_scaled_lut_output.z;
  bool _860 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_860) {
    float _870 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _855;
    float _871 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _856;
    float _872 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _857;
    bool _873 = (_870 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_873) {
      float _875 = _870 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _876 = 1.0f - _875;
      float _877 = _876 * _876;
      float _878 = _877 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _879 = _878 + _870;
      _881 = _879;
    } else {
      _881 = _870;
    }
    bool _882 = (_871 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_882) {
      float _884 = _871 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _885 = 1.0f - _884;
      float _886 = _885 * _885;
      float _887 = _886 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _888 = _887 + _871;
      _890 = _888;
    } else {
      _890 = _871;
    }
    bool _891 = (_872 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_891) {
      float _893 = _872 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _894 = 1.0f - _893;
      float _895 = _894 * _894;
      float _896 = _895 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _897 = _896 + _872;
      _899 = _897;
    } else {
      _899 = _872;
    }
    float _900 = _881 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _901 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
    float _902 = log2(_900);
    float _903 = _902 * _901;
    float _904 = exp2(_903);
    float _905 = _904 + -1.0f;
    float _906 = _900 + -1.0f;
    float _907 = _905 / _906;
    bool _908 = !(_900 == 1.0f);
    float _909 = _907 + -1.0f;
    float _910 = _909 / _907;
    float _911 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _912 = _911 / _901;
    float _913 = select(_908, _910, _912);
    float _914 = _913 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _915 = _890 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _916 = log2(_915);
    float _917 = _916 * _901;
    float _918 = exp2(_917);
    float _919 = _918 + -1.0f;
    float _920 = _915 + -1.0f;
    ...
    float _926 = _925 / _901;
    float _927 = select(_922, _924, _926);
    float _928 = _927 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _929 = _899 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _930 = log2(_929);
    float _931 = _930 * _901;
    float _932 = exp2(_931);
    float _933 = _932 + -1.0f;
    float _934 = _929 + -1.0f;
    float _935 = _933 / _934;
    bool _936 = !(_929 == 1.0f);
    float _937 = _935 + -1.0f;
    float _938 = _937 / _935;
    float _939 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _940 = _939 / _901;
    float _941 = select(_936, _938, _940);
    float _942 = _941 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _943 = _914 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _944 = _928 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _945 = _942 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    _947 = _943;
    _948 = _944;
    _949 = _945;
  } else {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      float3(_855, _856, _857),
      float3(_947, _948, _949),
      false);
  _947 = resonance_post_process_output.x;
  _948 = resonance_post_process_output.y;
  _949 = resonance_post_process_output.z;
  float _950 = log2(_947);
  float _951 = log2(_948);
  float _952 = log2(_949);
  float _953 = _950 * 0.4166666567325592f;
  float _954 = _951 * 0.4166666567325592f;
  float _955 = _952 * 0.4166666567325592f;
  float _956 = exp2(_953);
  float _957 = exp2(_954);
  float _958 = exp2(_955);
  float _959 = _956 * 1.0549999475479126f;
  float _960 = _957 * 1.0549999475479126f;
  float _961 = _958 * 1.0549999475479126f;
  float _962 = _959 + -0.054999999701976776f;
  float _963 = _960 + -0.054999999701976776f;
  float _964 = _961 + -0.054999999701976776f;
  float _965 = _947 * 12.920000076293945f;
  float _966 = _948 * 12.920000076293945f;
  float _967 = _949 * 12.920000076293945f;
  bool _968 = (_947 <= 0.0031308000907301903f);
  bool _969 = (_948 <= 0.0031308000907301903f);
  bool _970 = (_949 <= 0.0031308000907301903f);
  float _971 = select(_968, _965, _962);
  float _972 = select(_969, _966, _963);
  float _973 = select(_970, _967, _964);
  ...
  bool _987 = (_972 <= 0.0f);
  bool _988 = (_973 <= 0.0f);
  float _989 = select(_986, 0.0f, _983);
  float _990 = select(_987, 0.0f, _984);
  float _991 = select(_988, 0.0f, _985);
  int _994 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  uint _995 = uint(SV_Position.x);
  uint _996 = uint(SV_Position.y);
  int _997 = _995 & 63;
  int _998 = _996 & 63;
  float4 _1000 = t1.Load(int4(_997, _998, _994, 0));
  float4 _1003 = t6.Load(int4(_997, _998, _994, 0));
  float _1006 = _1000.x * _989;
  float _1007 = _1003.x * _990;
  float _1008 = _1003.y * _991;
  float _1009 = _1006 + _971;
  float _1010 = _1007 + _972;
  float _1011 = _1008 + _973;
  SV_Target.x = _1009;
  SV_Target.y = _1010;
  SV_Target.z = _1011;
  SV_Target.w = _372;
