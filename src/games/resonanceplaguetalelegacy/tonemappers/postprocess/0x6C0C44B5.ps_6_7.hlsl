...
float4 main(
  ...
  bool _385 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !ResonanceIsPsychoV();
  if (_385) {
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      false);
  _471 = resonance_post_process_output.x;
  _472 = resonance_post_process_output.y;
  _473 = resonance_post_process_output.z;
