...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _234 = resonance_scaled_lut_output.x;
  _235 = resonance_scaled_lut_output.y;
  _236 = resonance_scaled_lut_output.z;
  bool _239 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_239) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _799 = resonance_perceptual_film_grain.x;
  ...
  float _813 = resonance_perceptual_film_grain.y;
  ...
  float _826 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _839 = resonance_post_process_output.x;
  float _840 = resonance_post_process_output.y;
  float _841 = resonance_post_process_output.z;
