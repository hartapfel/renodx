...
float4 main(
  ...
  float _263 = ResonanceScaleVignetteMask(exp2(_262));
  ...
  bool _321 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_321) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _881 = resonance_perceptual_film_grain.x;
  ...
  float _895 = resonance_perceptual_film_grain.y;
  ...
  float _908 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _921 = resonance_post_process_output.x;
  float _922 = resonance_post_process_output.y;
  float _923 = resonance_post_process_output.z;
