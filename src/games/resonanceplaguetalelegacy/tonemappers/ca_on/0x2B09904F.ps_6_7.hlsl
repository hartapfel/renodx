...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _627 = resonance_scaled_lut_output.x;
  _628 = resonance_scaled_lut_output.y;
  _629 = resonance_scaled_lut_output.z;
  bool _632 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_632) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1192 = resonance_perceptual_film_grain.x;
  ...
  float _1206 = resonance_perceptual_film_grain.y;
  ...
  float _1219 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1232 = resonance_post_process_output.x;
  float _1233 = resonance_post_process_output.y;
  float _1234 = resonance_post_process_output.z;
