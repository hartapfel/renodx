...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _670 = resonance_scaled_lut_output.x;
  _671 = resonance_scaled_lut_output.y;
  _672 = resonance_scaled_lut_output.z;
  bool _675 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_675) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1235 = resonance_perceptual_film_grain.x;
  ...
  float _1249 = resonance_perceptual_film_grain.y;
  ...
  float _1262 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1275 = resonance_post_process_output.x;
  float _1276 = resonance_post_process_output.y;
  float _1277 = resonance_post_process_output.z;
