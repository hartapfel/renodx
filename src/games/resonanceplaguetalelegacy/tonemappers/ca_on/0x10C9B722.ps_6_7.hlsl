...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _636 = resonance_scaled_lut_output.x;
  _637 = resonance_scaled_lut_output.y;
  _638 = resonance_scaled_lut_output.z;
  bool _641 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_641) {
  ...
  _1297 = resonance_film_grain_output.x;
  _1298 = resonance_film_grain_output.y;
  _1299 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1339 = resonance_post_process_output.x;
  float _1340 = resonance_post_process_output.y;
  float _1341 = resonance_post_process_output.z;
