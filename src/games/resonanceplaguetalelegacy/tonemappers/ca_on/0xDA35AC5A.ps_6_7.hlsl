...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _662 = resonance_scaled_lut_output.x;
  _663 = resonance_scaled_lut_output.y;
  _664 = resonance_scaled_lut_output.z;
  bool _667 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_667) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1227 = resonance_perceptual_film_grain.x;
  ...
  float _1241 = resonance_perceptual_film_grain.y;
  ...
  float _1254 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1267 = resonance_post_process_output.x;
  float _1268 = resonance_post_process_output.y;
  float _1269 = resonance_post_process_output.z;
