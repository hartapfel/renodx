...
float4 main(
  ...
  float _618 = ResonanceScaleVignetteMask(exp2(_617));
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _671 = resonance_scaled_lut_output.x;
  _672 = resonance_scaled_lut_output.y;
  _673 = resonance_scaled_lut_output.z;
  bool _676 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_676) {
  ...
  _1332 = resonance_film_grain_output.x;
  _1333 = resonance_film_grain_output.y;
  _1334 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1374 = resonance_post_process_output.x;
  float _1375 = resonance_post_process_output.y;
  float _1376 = resonance_post_process_output.z;
