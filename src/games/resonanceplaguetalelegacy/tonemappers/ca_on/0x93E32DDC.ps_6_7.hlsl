...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _679 = resonance_scaled_lut_output.x;
  _680 = resonance_scaled_lut_output.y;
  _681 = resonance_scaled_lut_output.z;
  bool _684 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_684) {
  ...
  _1340 = resonance_film_grain_output.x;
  _1341 = resonance_film_grain_output.y;
  _1342 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1382 = resonance_post_process_output.x;
  float _1383 = resonance_post_process_output.y;
  float _1384 = resonance_post_process_output.z;
