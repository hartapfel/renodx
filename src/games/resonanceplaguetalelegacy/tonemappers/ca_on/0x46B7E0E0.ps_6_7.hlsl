...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _281 = resonance_scaled_lut_output.x;
  _282 = resonance_scaled_lut_output.y;
  _283 = resonance_scaled_lut_output.z;
  bool _286 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_286) {
  ...
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _846 = resonance_perceptual_film_grain.x;
  ...
  float _860 = resonance_perceptual_film_grain.y;
  ...
  float _873 = resonance_perceptual_film_grain.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _886 = resonance_post_process_output.x;
  float _887 = resonance_post_process_output.y;
  float _888 = resonance_post_process_output.z;
