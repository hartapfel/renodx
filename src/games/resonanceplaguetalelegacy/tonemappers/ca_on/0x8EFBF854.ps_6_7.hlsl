...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _284 = resonance_scaled_lut_output.x;
  _285 = resonance_scaled_lut_output.y;
  _286 = resonance_scaled_lut_output.z;
  bool _289 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_289) {
  ...
  _945 = resonance_film_grain_output.x;
  _946 = resonance_film_grain_output.y;
  _947 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _987 = resonance_post_process_output.x;
  float _988 = resonance_post_process_output.y;
  float _989 = resonance_post_process_output.z;
