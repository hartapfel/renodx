...
float4 main(
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _237 = resonance_scaled_lut_output.x;
  _238 = resonance_scaled_lut_output.y;
  _239 = resonance_scaled_lut_output.z;
  bool _242 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_242) {
  ...
  _898 = resonance_film_grain_output.x;
  _899 = resonance_film_grain_output.y;
  _900 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _940 = resonance_post_process_output.x;
  float _941 = resonance_post_process_output.y;
  float _942 = resonance_post_process_output.z;
