...
float4 main(
  ...
  float _582 = _576.x * (Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[87].y);
  float _583 = _582 * _570;
  float _584 = _583 * (PostProcess_000.PostProcessConstant_Z_000[14].x);
  float _585 = _582 * _571;
  float _586 = _585 * (PostProcess_000.PostProcessConstant_Z_000[14].y);
  float _587 = _582 * _572;
  float _588 = _587 * (PostProcess_000.PostProcessConstant_Z_000[14].z);
  float _593 = _60 * 2.0f;
  float _594 = _61 * 2.0f;
  float _595 = _593 + -1.0f;
  float _596 = _594 + -1.0f;
  float _599 = (PostProcess_000.PostProcessConstant_Z_000[13].w) * _596;
  float _600 = _595 * _595;
  float _601 = _599 * _599;
  float _602 = _601 + _600;
  float _603 = sqrt(_602);
  float _605 = (PostProcess_000.PostProcessConstant_Z_000[13].x) * _603;
  float _607 = _605 + (PostProcess_000.PostProcessConstant_Z_000[13].y);
  float _608 = saturate(_607);
  float _610 = log2(_608);
  float _611 = _610 * (PostProcess_000.PostProcessConstant_Z_000[13].z);
  float _612 = ResonanceScaleVignetteMask(exp2(_611));
  float _613 = _584 * (PostProcess_000.PostProcessConstant_Z_000[12].x);
  float _614 = _586 * (PostProcess_000.PostProcessConstant_Z_000[12].y);
  float _615 = _588 * (PostProcess_000.PostProcessConstant_Z_000[12].z);
  ...
  float _627 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * 1.1190600395202637f;
  ...
  float _644 = _640 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float _645 = _641 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float _646 = _642 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float4 _649 = t3.Sample(s3, float3(_644, _645, _646));
  ...
  float _664 = 0.8936070799827576f / (PostProcess_000.PostProcessConstant_Z_000[10].w);
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _665 = resonance_scaled_lut_output.x;
  _666 = resonance_scaled_lut_output.y;
  _667 = resonance_scaled_lut_output.z;
  bool _670 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_670) {
    ...
    int _686 = asint((User_000.UserConstant_Z_000[3].y));
    int _687 = _686 & 1;
    bool _688 = (_687 == 0);
    if (!_688) {
      bool _705 = !(_682 <= (User_000.UserConstant_Z_000[4].x));
      if (!_705) {
        float _707 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        float _708 = _682 / _707;
        float _709 = _708 * (User_000.UserConstant_Z_000[4].y);
        float _710 = _708 * _708;
        float _711 = _710 * _708;
        float _712 = _711 - _708;
        float _713 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _719 = !(_682 <= (User_000.UserConstant_Z_000[4].z));
        if (!_719) {
          float _721 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _722 = max(9.999999974752427e-07f, _721);
          float _723 = _682 - (User_000.UserConstant_Z_000[4].x);
          float _724 = _723 / _722;
          float _725 = 1.0f - _724;
          float _726 = _725 * (User_000.UserConstant_Z_000[4].y);
          float _727 = _724 * (User_000.UserConstant_Z_000[4].w);
          float _728 = _726 + _727;
          float _729 = _725 * _725;
          float _730 = _729 * _725;
          float _731 = _730 - _725;
          float _732 = _731 * (User_000.UserConstant_Z_000[10].x);
          float _733 = _724 * _724;
          float _734 = _733 * _724;
          float _735 = _734 - _724;
          float _736 = _735 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _743 = !(_682 <= (User_000.UserConstant_Z_000[9].x));
          if (!_743) {
            float _745 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _746 = max(9.999999974752427e-07f, _745);
            float _747 = _682 - (User_000.UserConstant_Z_000[4].z);
            float _748 = _747 / _746;
            float _749 = 1.0f - _748;
            float _750 = _749 * (User_000.UserConstant_Z_000[4].w);
            float _751 = _748 * (User_000.UserConstant_Z_000[9].y);
            float _752 = _750 + _751;
            float _753 = _749 * _749;
            float _754 = _753 * _749;
            float _755 = _754 - _749;
            float _756 = _755 * (User_000.UserConstant_Z_000[10].y);
            float _757 = _748 * _748;
            float _758 = _757 * _748;
            float _759 = _758 - _748;
            float _760 = _759 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _767 = !(_682 <= (User_000.UserConstant_Z_000[9].z));
            if (!_767) {
              float _769 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _770 = max(9.999999974752427e-07f, _769);
              float _771 = _682 - (User_000.UserConstant_Z_000[9].x);
              float _772 = _771 / _770;
              float _773 = 1.0f - _772;
              float _774 = _773 * (User_000.UserConstant_Z_000[9].y);
              float _775 = _772 * (User_000.UserConstant_Z_000[9].w);
              float _776 = _774 + _775;
              float _777 = _773 * _773;
              float _778 = _777 * _773;
              float _779 = _778 - _773;
              float _780 = _779 * (User_000.UserConstant_Z_000[10].z);
              float _781 = _772 * _772;
              float _782 = _781 * _772;
              float _783 = _782 - _772;
              float _784 = _783 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _791 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _792 = _682 - (User_000.UserConstant_Z_000[9].z);
              float _793 = max(9.999999974752427e-07f, _791);
              float _794 = _792 / _793;
              float _795 = 1.0f - _794;
              float _796 = _795 * (User_000.UserConstant_Z_000[9].w);
              float _797 = _796 + _794;
              float _798 = _795 * _795;
              float _799 = _798 * _795;
              float _800 = _799 - _795;
              float _801 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
      ...
      bool _809 = !(_683 <= (User_000.UserConstant_Z_000[4].x));
      if (!_809) {
        float _811 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        float _812 = _683 / _811;
        float _813 = _812 * (User_000.UserConstant_Z_000[4].y);
        float _814 = _812 * _812;
        float _815 = _814 * _812;
        float _816 = _815 - _812;
        float _817 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _823 = !(_683 <= (User_000.UserConstant_Z_000[4].z));
        if (!_823) {
          float _825 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _826 = max(9.999999974752427e-07f, _825);
          float _827 = _683 - (User_000.UserConstant_Z_000[4].x);
          float _828 = _827 / _826;
          float _829 = 1.0f - _828;
          float _830 = _829 * (User_000.UserConstant_Z_000[4].y);
          float _831 = _828 * (User_000.UserConstant_Z_000[4].w);
          float _832 = _830 + _831;
          float _833 = _829 * _829;
          float _834 = _833 * _829;
          float _835 = _834 - _829;
          float _836 = _835 * (User_000.UserConstant_Z_000[10].x);
          float _837 = _828 * _828;
          float _838 = _837 * _828;
          float _839 = _838 - _828;
          float _840 = _839 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _847 = !(_683 <= (User_000.UserConstant_Z_000[9].x));
          if (!_847) {
            float _849 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _850 = max(9.999999974752427e-07f, _849);
            float _851 = _683 - (User_000.UserConstant_Z_000[4].z);
            float _852 = _851 / _850;
            float _853 = 1.0f - _852;
            float _854 = _853 * (User_000.UserConstant_Z_000[4].w);
            float _855 = _852 * (User_000.UserConstant_Z_000[9].y);
            float _856 = _854 + _855;
            float _857 = _853 * _853;
            float _858 = _857 * _853;
            float _859 = _858 - _853;
            float _860 = _859 * (User_000.UserConstant_Z_000[10].y);
            float _861 = _852 * _852;
            float _862 = _861 * _852;
            float _863 = _862 - _852;
            float _864 = _863 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _871 = !(_683 <= (User_000.UserConstant_Z_000[9].z));
            if (!_871) {
              float _873 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _874 = max(9.999999974752427e-07f, _873);
              float _875 = _683 - (User_000.UserConstant_Z_000[9].x);
              float _876 = _875 / _874;
              float _877 = 1.0f - _876;
              float _878 = _877 * (User_000.UserConstant_Z_000[9].y);
              float _879 = _876 * (User_000.UserConstant_Z_000[9].w);
              float _880 = _878 + _879;
              float _881 = _877 * _877;
              float _882 = _881 * _877;
              float _883 = _882 - _877;
              float _884 = _883 * (User_000.UserConstant_Z_000[10].z);
              float _885 = _876 * _876;
              float _886 = _885 * _876;
              float _887 = _886 - _876;
              float _888 = _887 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _895 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _896 = _683 - (User_000.UserConstant_Z_000[9].z);
              float _897 = max(9.999999974752427e-07f, _895);
              float _898 = _896 / _897;
              float _899 = 1.0f - _898;
              float _900 = _899 * (User_000.UserConstant_Z_000[9].w);
              float _901 = _900 + _898;
              float _902 = _899 * _899;
              float _903 = _902 * _899;
              float _904 = _903 - _899;
              float _905 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
      ...
      bool _913 = !(_684 <= (User_000.UserConstant_Z_000[4].x));
      if (!_913) {
        float _915 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        float _916 = _684 / _915;
        float _917 = _916 * (User_000.UserConstant_Z_000[4].y);
        float _918 = _916 * _916;
        float _919 = _918 * _916;
        float _920 = _919 - _916;
        float _921 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _927 = !(_684 <= (User_000.UserConstant_Z_000[4].z));
        if (!_927) {
          float _929 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _930 = max(9.999999974752427e-07f, _929);
          float _931 = _684 - (User_000.UserConstant_Z_000[4].x);
          float _932 = _931 / _930;
          float _933 = 1.0f - _932;
          float _934 = _933 * (User_000.UserConstant_Z_000[4].y);
          float _935 = _932 * (User_000.UserConstant_Z_000[4].w);
          float _936 = _934 + _935;
          float _937 = _933 * _933;
          float _938 = _937 * _933;
          float _939 = _938 - _933;
          float _940 = _939 * (User_000.UserConstant_Z_000[10].x);
          float _941 = _932 * _932;
          float _942 = _941 * _932;
          float _943 = _942 - _932;
          float _944 = _943 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _951 = !(_684 <= (User_000.UserConstant_Z_000[9].x));
          if (!_951) {
            float _953 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _954 = max(9.999999974752427e-07f, _953);
            float _955 = _684 - (User_000.UserConstant_Z_000[4].z);
            float _956 = _955 / _954;
            float _957 = 1.0f - _956;
            float _958 = _957 * (User_000.UserConstant_Z_000[4].w);
            float _959 = _956 * (User_000.UserConstant_Z_000[9].y);
            float _960 = _958 + _959;
            float _961 = _957 * _957;
            float _962 = _961 * _957;
            float _963 = _962 - _957;
            float _964 = _963 * (User_000.UserConstant_Z_000[10].y);
            float _965 = _956 * _956;
            float _966 = _965 * _956;
            float _967 = _966 - _956;
            float _968 = _967 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _975 = !(_684 <= (User_000.UserConstant_Z_000[9].z));
            if (!_975) {
              float _977 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _978 = max(9.999999974752427e-07f, _977);
              float _979 = _684 - (User_000.UserConstant_Z_000[9].x);
              float _980 = _979 / _978;
              float _981 = 1.0f - _980;
              float _982 = _981 * (User_000.UserConstant_Z_000[9].y);
              float _983 = _980 * (User_000.UserConstant_Z_000[9].w);
              float _984 = _982 + _983;
              float _985 = _981 * _981;
              float _986 = _985 * _981;
              float _987 = _986 - _981;
              float _988 = _987 * (User_000.UserConstant_Z_000[10].z);
              float _989 = _980 * _980;
              float _990 = _989 * _980;
              float _991 = _990 - _980;
              float _992 = _991 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _999 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _1000 = _684 - (User_000.UserConstant_Z_000[9].z);
              float _1001 = max(9.999999974752427e-07f, _999);
              float _1002 = _1000 / _1001;
              float _1003 = 1.0f - _1002;
              float _1004 = _1003 * (User_000.UserConstant_Z_000[9].w);
              float _1005 = _1004 + _1002;
              float _1006 = _1003 * _1003;
              float _1007 = _1006 * _1003;
              float _1008 = _1007 - _1003;
              float _1009 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
    ...
    if (_1033) {
      ...
      if (!_1036) {
        ...
        bool _1039 = (_1038 == 0);
        if (!_1039) {
          float _1043 = (User_000.UserConstant_Z_000[5].x) * 0.5f;
          float _1044 = _1043 + 0.5f;
          bool _1045 = (_1044 < 0.5f);
          float _1046 = (User_000.UserConstant_Z_000[5].x) * 5.0f;
          float _1047 = select(_1045, (User_000.UserConstant_Z_000[5].x), _1046);
          ...
          float _1059 = _1057 - (User_000.UserConstant_Z_000[5].y);
          ...
          float _1067 = 1.0f - (User_000.UserConstant_Z_000[5].z);
          ...
          if (!_1090) {
            float _1094 = abs(User_000.UserConstant_Z_000[5].x);
            float _1095 = saturate(_1094);
            uint4 _1097 = 0u; t15.GetDimensions(0u, _1097.x, _1097.y, _1097.w);
            ...
            if (!_1102) {
              ...
              int _1108 = _1106 & 63;
              int _1109 = _1107 & 63;
              float4 _1111 = t6.Load(int4(_1108, _1109, 0, 0));
            ...
            float4 _1177 = t15.Sample(s0, float2(_1172, _1167));
            float4 _1181 = t15.Sample(s0, float2(_1175, _1167));
  ...
  float _1228 = (User_000.UserConstant_Z_000[8].x) * _1221;
  float _1229 = (User_000.UserConstant_Z_000[8].y) * _1222;
  float _1230 = (User_000.UserConstant_Z_000[8].z) * _1223;
  float3 resonance_perceptual_film_grain = ResonanceApplyPerceptualFilmGrain(
      float3(_1228, _1229, _1230),
      SV_Position.xy);
  float _1235 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * TEXCOORD.x;
  float _1236 = _1235 * (PostProcess_000.PostProcessConstant_Z_000[9].x);
  float _1237 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * TEXCOORD.y;
  float _1238 = _1237 * (PostProcess_000.PostProcessConstant_Z_000[9].y);
  float _1241 = _1236 + (PostProcess_000.PostProcessConstant_Z_000[9].z);
  float _1242 = _1238 + (PostProcess_000.PostProcessConstant_Z_000[9].w);
  float4 _1245 = t9.Sample(s9, float2(_1241, _1242));
  float _1249 = dot(float3(_1228, _1229, _1230), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
  bool _1252 = ((PostProcess_000.PostProcessConstant_Z_000[10].x) > 0.0f);
  int _1255 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  int _1256 = select(_1252, _1255, 0);
  float _1257 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * SV_Position.x;
  float _1258 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * SV_Position.y;
  uint _1259 = uint(_1257);
  uint _1260 = uint(_1258);
  int _1261 = _1259 & 63;
  int _1262 = _1260 & 63;
  float4 _1264 = t6.Load(int4(_1261, _1262, _1256, 0));
  bool _1266 = ((PostProcess_000.PostProcessConstant_Z_000[10].z) < 1.0f);
  if (_1266) {
    float _1268 = _1257 * 0.015625f;
    float _1269 = _1258 * 0.015625f;
    float _1270 = float((uint)_1255);
    float _1271 = select(_1252, _1270, 0.0f);
    float4 _1273 = t6.SampleLevel(s1, float3(_1268, _1269, _1271), 0.0f);
    float _1275 = _1264.y - _1273.y;
    float _1276 = _1275 * (PostProcess_000.PostProcessConstant_Z_000[10].z);
  ...
  bool _1301 = ((PostProcess_000.PostProcessConstant_Z_000[10].y) > 0.0f);
  ...
  float _1316 = (PostProcess_000.PostProcessConstant_Z_000[2].y) - (PostProcess_000.PostProcessConstant_Z_000[2].x);
  float _1317 = _1316 * _1292;
  float _1318 = _1317 + (PostProcess_000.PostProcessConstant_Z_000[2].x);
  ...
  _1326 = resonance_film_grain_output.x;
  _1327 = resonance_film_grain_output.y;
  _1328 = resonance_film_grain_output.z;
  float _1331 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
  ...
  float _1341 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  ...
  float _1353 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  ...
  float _1365 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1368 = resonance_post_process_output.x;
  float _1369 = resonance_post_process_output.y;
  float _1370 = resonance_post_process_output.z;
  ...
  int _1397 = _1395 & 63;
  int _1398 = _1396 & 63;
  float4 _1400 = t1.Load(int4(_1397, _1398, _1255, 0));
