...
float4 main(
  ...
  float _661 = ResonanceScaleVignetteMask(exp2(_660));
  ...
  float3 resonance_scaled_lut_output = ResonanceApplyPostProcessLUT(
      ...
      1.f.xxx);
  _714 = resonance_scaled_lut_output.x;
  _715 = resonance_scaled_lut_output.y;
  _716 = resonance_scaled_lut_output.z;
  bool _719 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !ResonanceIsPsychoV();
  if (_719) {
  ...
  _1375 = resonance_film_grain_output.x;
  _1376 = resonance_film_grain_output.y;
  _1377 = resonance_film_grain_output.z;
  ...
  float3 resonance_post_process_output = ResonanceApplyPostProcessToneMap(
      ...
      true);
  float _1417 = resonance_post_process_output.x;
  float _1418 = resonance_post_process_output.y;
  float _1419 = resonance_post_process_output.z;
