...
struct ShaderInjectData {
  ...
  float padding_graphics_white_nits;
  float tone_map_type;
...
// Keep the internal UI/reference-white scale at the former neutral default.
// It remains part of the intermediate-pass math, but is no longer exposed as
// a user control because changing it does not isolate UI brightness correctly.
