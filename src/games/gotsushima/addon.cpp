...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = "Hue Shift",
        .section = "Tone Mapping",
        .tooltip = "Shifts PsychoV-30 fire hues away from pink towards orange, matching Resonance Legacy. 0 keeps the baseline hue; 100 matches the original full shift. Values up to 500 extend the shift further. Also affects other scene colors.",
        .max = 100.f,
        .is_enabled = []() { return IsPsychoV(); },
    ...
    new renodx::utils::settings::Setting{
        ...
        .section = "Effects",
        .tooltip = "Scales native bloom before tone mapping. 100% preserves the original intensity; 0% disables bloom. Does not scale lens flares.",
        .max = 200.f,
        .format = "%.0f%%",
        .is_enabled = []() { return IsPsychoV(); },
        .parse = [](float value) { return value * 0.01f; },
