...
Five PsychoV controls have separate SDR defaults: Highlights **50**, Blowout **0**, Flare **0**, Cone Response Exponent **1.0**, and Compression **2.0**. Their HDR defaults are **42**, **10**, **60**, **1.17**, and **Auto/0**, respectively. The sliders remain adjustable, and their SDR and HDR values are saved separately for each RenoDX preset. All other defaults are shared across output modes.
