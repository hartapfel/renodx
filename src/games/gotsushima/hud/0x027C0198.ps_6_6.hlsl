...
float4 main(
  ...
  float _89 = cb13_000x * _73;
  float _90 = mad(_74, cb13_001x, _89);
  float _91 = mad(_75, cb13_002x, _90);
  float _92 = cb13_000y * _73;
  float _93 = mad(_74, cb13_001y, _92);
  float _94 = mad(_75, cb13_002y, _93);
  float _95 = cb13_000z * _73;
  float _96 = mad(_74, cb13_001z, _95);
  float _97 = mad(_75, cb13_002z, _96);
  float _98 = dot(float3(_91, _94, _97), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
  float _101 = _98 - _91;
  float _102 = _98 - _94;
  float _103 = _98 - _97;
  float _104 = cbufGlobal_288 * _101;
  float _105 = cbufGlobal_288 * _102;
  float _106 = cbufGlobal_288 * _103;
  float _107 = _104 + _91;
  float _108 = _105 + _94;
  float _109 = _106 + _97;
  float _110 = _72 * _76;
  float _113 = _110 * cb12_008w;
  float _114 = _113 * _107;
  float _115 = _113 * _108;
  float _116 = _113 * _109;
  SV_Target.x = _114;
  SV_Target.y = _115;
  SV_Target.z = _116;
  SV_Target.w = _110;
  if (GhostIsUIOverrideActive()) {
    SV_Target.rgb = GhostRenderUI(float3(_107, _108, _109) * _110, _110);
  }
  return SV_Target;
}
