...
float4 main(
  ...
  float4 _40 = t10.Sample(s3, float2(_36, _37));
  bool _42 = (TEXCOORD_3 < _40.x);
  float _49;
  if (_42) {
    float _47 = cb13_005z * _22.w;
    _49 = _47;
  } else {
    _49 = _22.w;
  }
  float _50 = _22.x * TEXCOORD.x;
  float _51 = _22.y * TEXCOORD.y;
  float _52 = _22.z * TEXCOORD.z;
  float _53 = _49 * TEXCOORD.w;
  float _54 = dot(float3(_50, _51, _52), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
  float _57 = _54 - _50;
  float _58 = _54 - _51;
  float _59 = _54 - _52;
  ...
  if (GhostIsUIOverrideActive()) {
    SV_Target.rgb = GhostRenderUI(float3(_63, _64, _65) * _53, _53);
  }
  return SV_Target;
}
