...
float4 main(
  ...
  float3 renodx_chromatic_aberration_input = APTSelectChromaticAberrationInput(
      ...
      s0Sampler,
      _47);
  _57 = renodx_chromatic_aberration_input.x;
  _58 = renodx_chromatic_aberration_input.y;
  _59 = renodx_chromatic_aberration_input.z;
  ...
  float _189 = APTScaleVignetteMask(exp2(_188));
  ...
  bool _436 = ((User.c[3].x) > 0.0f) && !APTIsPsychoV();
  if (_436) {
  ...
  float _938 = _937 * 3.0f;
  float _939 = exp2(_938);
  float _940 = _939 + -1.0f;
  float _941 = _934 + -1.0f;
  float _942 = _940 / _941;
  float _943 = _942 + -1.0f;
  bool _944 = !(_934 == 1.0f);
  float _945 = _943 / _942;
  float _946 = select(_944, _945, 0.6666666865348816f);
  float _947 = log2(_935);
  float _948 = _947 * 3.0f;
  float _949 = exp2(_948);
  float _950 = _949 + -1.0f;
  float _951 = _935 + -1.0f;
  float _952 = _950 / _951;
  float _953 = _952 + -1.0f;
  bool _954 = !(_935 == 1.0f);
  float _955 = _953 / _952;
  float _956 = select(_954, _955, 0.6666666865348816f);
  float _957 = log2(_936);
  float _958 = _957 * 3.0f;
  float _959 = exp2(_958);
  float _960 = _959 + -1.0f;
  float _961 = _936 + -1.0f;
  float _962 = _960 / _961;
  float _963 = _962 + -1.0f;
  bool _964 = !(_936 == 1.0f);
  float _965 = _963 / _962;
  float _966 = select(_964, _965, 0.6666666865348816f);
  float _967 = saturate(_946);
  float _968 = saturate(_956);
  float _969 = saturate(_966);
  float3 apt_tonemapped = APTApplyPostProcessToneMap(
      float3(_431, _432, _433),
      float3(_967, _968, _969),
      false);
  _967 = apt_tonemapped.x;
  _968 = apt_tonemapped.y;
  _969 = apt_tonemapped.z;
  bool _970 = (_967 <= 0.0031308000907301903f);
  bool _971 = (_968 <= 0.0031308000907301903f);
  bool _972 = (_969 <= 0.0031308000907301903f);
  float _973 = _967 * 12.920000076293945f;
  float _974 = _968 * 12.920000076293945f;
  float _975 = _969 * 12.920000076293945f;
  float _976 = log2(_967);
  float _977 = log2(_968);
  float _978 = log2(_969);
  float _979 = _976 * 0.4166666567325592f;
  float _980 = _977 * 0.4166666567325592f;
  float _981 = _978 * 0.4166666567325592f;
  float _982 = exp2(_979);
  float _983 = exp2(_980);
  float _984 = exp2(_981);
  float _985 = _982 * 1.0549999475479126f;
  float _986 = _983 * 1.0549999475479126f;
  float _987 = _984 * 1.0549999475479126f;
  float _988 = _985 + -0.054999999701976776f;
  float _989 = _986 + -0.054999999701976776f;
  float _990 = _987 + -0.054999999701976776f;
  float _991 = select(_970, _973, _988);
  float _992 = select(_971, _974, _989);
  float _993 = select(_972, _975, _990);
  int _996 = asint((Global.c[1].w));
  uint _997 = uint(SV_Position.x);
  uint _998 = uint(SV_Position.y);
  int _999 = _997 & 63;
  int _1000 = _998 & 63;
  float4 _1001 = sBlueNoiseR8.Load(int4(_999, _1000, _996, 0));
  float _1003 = _1001.x * 0.003921568859368563f;
  float _1004 = _991 + 0.003921568859368563f;
  float _1005 = _1004 - _1003;
  float _1006 = _1003 + _992;
  float _1007 = _1003 + _993;
  SV_Target.x = _1005;
  SV_Target.y = _1006;
  SV_Target.z = _1007;
  SV_Target.w = _52.w;
