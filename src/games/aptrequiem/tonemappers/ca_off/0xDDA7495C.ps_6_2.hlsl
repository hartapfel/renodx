...
float4 main(
  ...
  bool _308 = ((User.c[3].x) > 0.0f) && !APTIsPsychoV();
  float _430;
  float _486;
  float _542;
  float _545;
      ...
      if (!_572) {
        ...
        if (!_575) {
          ...
          if (!_626) {
            ...
            uint2 _632; s15.GetDimensions(_632.x, _632.y);
  ...
  float _832 = select(_811, _814, _829);
  float _833 = log2(_830);
  float _834 = log2(_831);
  float _835 = log2(_832);
  float _836 = floor(_833);
  float _837 = floor(_834);
  float _838 = floor(_835);
  float _839 = _836 + -6.0f;
  float _840 = _837 + -6.0f;
  float _841 = _838 + -5.0f;
  float _842 = exp2(_839);
  float _843 = exp2(_840);
  float _844 = exp2(_841);
  uint _845 = uint(SV_Position.x);
  uint _846 = uint(SV_Position.y);
  int _847 = _845 & 63;
  int _848 = _846 & 63;
  float4 _849 = sBlueNoiseR8.Load(int4(_847, _848, 0, 0));
  float _851 = _849.x + -0.5f;
  bool _852 = (_830 > 0.0f);
  bool _853 = (_831 > 0.0f);
  bool _854 = (_832 > 0.0f);
  float _855 = float((bool)_852);
  float _856 = float((bool)_853);
  float _857 = float((bool)_854);
  float _858 = _842 * _855;
  float _859 = _858 * _851;
  float _860 = _843 * _856;
  float _861 = _860 * _851;
  float _862 = _844 * _857;
  float _863 = _862 * _851;
  float _864 = _859 + _830;
  float _865 = _861 + _831;
  float _866 = _863 + _832;
  SV_Target.x = _864;
  SV_Target.y = _865;
  SV_Target.z = _866;
  SV_Target.w = _50.w;
