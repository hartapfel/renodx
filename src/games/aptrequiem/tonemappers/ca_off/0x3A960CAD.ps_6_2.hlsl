...
float4 main(
  ...
  float _373 = APTScaleVignetteMask(exp2(_372));
  ...
  float3 apt_film_grain_output = APTSelectFilmGrainOutput(
      float3(_518, _519, _520),
      apt_lut_output);
  _518 = apt_film_grain_output.x;
  _519 = apt_film_grain_output.y;
  _520 = apt_film_grain_output.z;
  ...
  bool _620 = ((User.c[3].x) > 0.0f) && !APTIsPsychoV();
  if (_620) {
  ...
  float3 apt_tonemapped = APTApplyPostProcessToneMap(
      ...
      float3(_1118, _1119, _1120),
      false);
  _1118 = apt_tonemapped.x;
  _1119 = apt_tonemapped.y;
  _1120 = apt_tonemapped.z;
  ...
  if (APTIsPsychoV()) {
    SV_Target_out.rgb = APTRenderIntermediatePassDithered(
        apt_tonemapped,
        SV_Position.xy);
  }
