...
float4 main(
  ...
  if (_221) {
    ...
    if (_259) {
      ...
      uint _278 = _271 + 114u;
      uint _281 = _271 + 115u;
      float _296 = (CBufferGlobalConstant_Z_raw[_272].x) * _269;
      float _297 = mad(_270, (CBufferGlobalConstant_Z_raw[_272].y), _296);
      float _298 = mad(_265.x, (CBufferGlobalConstant_Z_raw[_272].z), _297);
      float _299 = _298 + (CBufferGlobalConstant_Z_raw[_272].w);
      float _300 = (CBufferGlobalConstant_Z_raw[_275].x) * _269;
      float _301 = mad(_270, (CBufferGlobalConstant_Z_raw[_275].y), _300);
      float _302 = mad(_265.x, (CBufferGlobalConstant_Z_raw[_275].z), _301);
      float _303 = _302 + (CBufferGlobalConstant_Z_raw[_275].w);
      float _304 = (CBufferGlobalConstant_Z_raw[_278].x) * _269;
      float _305 = mad(_270, (CBufferGlobalConstant_Z_raw[_278].y), _304);
      float _306 = mad(_265.x, (CBufferGlobalConstant_Z_raw[_278].z), _305);
      float _307 = _306 + (CBufferGlobalConstant_Z_raw[_278].w);
      float _308 = (CBufferGlobalConstant_Z_raw[_281].x) * _269;
      float _309 = mad(_270, (CBufferGlobalConstant_Z_raw[_281].y), _308);
      float _310 = mad(_265.x, (CBufferGlobalConstant_Z_raw[_281].z), _309);
      float _311 = _310 + (CBufferGlobalConstant_Z_raw[_281].w);
  ...
  float _416 = APTScaleVignetteMask(exp2(_415));
      ...
      if (!_835) {
        ...
        if (!_838) {
          ...
          if (!_889) {
            ...
            uint4 _895 = 0u; s15.GetDimensions(0u, _895.x, _895.y, _895.w);
  ...
  float3 apt_tonemapped = APTApplyPostProcessToneMap(
      ...
      false);
  _1069 = apt_tonemapped.x;
  _1070 = apt_tonemapped.y;
  _1071 = apt_tonemapped.z;
  bool _1072 = (_1069 <= 0.0031308000907301903f);
  bool _1073 = (_1070 <= 0.0031308000907301903f);
  bool _1074 = (_1071 <= 0.0031308000907301903f);
  float _1075 = _1069 * 12.920000076293945f;
  float _1076 = _1070 * 12.920000076293945f;
  float _1077 = _1071 * 12.920000076293945f;
  float _1078 = log2(_1069);
  float _1079 = log2(_1070);
  float _1080 = log2(_1071);
  float _1081 = _1078 * 0.4166666567325592f;
  ...
  float _1099 = floor(_1096);
  float _1100 = floor(_1097);
  float _1101 = floor(_1098);
  float _1102 = _1099 + -6.0f;
  float _1103 = _1100 + -6.0f;
  float _1104 = _1101 + -5.0f;
  float _1105 = exp2(_1102);
  float _1106 = exp2(_1103);
  float _1107 = exp2(_1104);
  uint _1108 = uint(SV_Position.x);
  uint _1109 = uint(SV_Position.y);
  int _1110 = _1108 & 63;
  int _1111 = _1109 & 63;
  float4 _1112 = sBlueNoiseR8.Load(int4(_1110, _1111, 0, 0));
  float _1114 = _1112.x + -0.5f;
  bool _1115 = (_1093 > 0.0f);
  bool _1116 = (_1094 > 0.0f);
  bool _1117 = (_1095 > 0.0f);
  float _1118 = float((bool)_1115);
  float _1119 = float((bool)_1116);
  float _1120 = float((bool)_1117);
  float _1121 = _1105 * _1118;
  float _1122 = _1121 * _1114;
  float _1123 = _1106 * _1119;
  float _1124 = _1123 * _1114;
  float _1125 = _1107 * _1120;
  float _1126 = _1125 * _1114;
  float _1127 = _1122 + _1093;
  float _1128 = _1124 + _1094;
  float _1129 = _1126 + _1095;
  SV_Target.x = _1127;
  SV_Target.y = _1128;
  SV_Target.z = _1129;
  SV_Target.w = _112.w;
