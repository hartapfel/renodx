...
float4 main(
  ...
  float3 renodx_chromatic_aberration_input = APTSelectChromaticAberrationInput(
      float3(_104, _105, _106),
      max(_101.rgb, 0.f.xxx),
      float2(_47, _48),
      s0,
      s0Sampler,
      _96);
  _104 = renodx_chromatic_aberration_input.x;
  _105 = renodx_chromatic_aberration_input.y;
  _106 = renodx_chromatic_aberration_input.z;
  ...
  float _232 = APTScaleVignetteMask(exp2(_231));
  ...
  bool _387 = ((User.c[3].x) > 0.0f) && !APTIsPsychoV();
  float _509;
  float _565;
  float _621;
  float _624;
      ...
      if (!_651) {
        ...
        if (!_654) {
          ...
          if (!_705) {
            ...
            uint4 _711 = 0u; s15.GetDimensions(0u, _711.x, _711.y, _711.w);
  ...
  float3 apt_tonemapped = APTApplyPostProcessToneMap(
      ...
      float3(_885, _886, _887),
      false);
  _885 = apt_tonemapped.x;
  _886 = apt_tonemapped.y;
  _887 = apt_tonemapped.z;
  bool _888 = (_885 <= 0.0031308000907301903f);
  bool _889 = (_886 <= 0.0031308000907301903f);
  bool _890 = (_887 <= 0.0031308000907301903f);
  float _891 = _885 * 12.920000076293945f;
  float _892 = _886 * 12.920000076293945f;
  float _893 = _887 * 12.920000076293945f;
  float _894 = log2(_885);
  float _895 = log2(_886);
  float _896 = log2(_887);
  float _897 = _894 * 0.4166666567325592f;
  float _898 = _895 * 0.4166666567325592f;
  float _899 = _896 * 0.4166666567325592f;
  float _900 = exp2(_897);
  float _901 = exp2(_898);
  float _902 = exp2(_899);
  float _903 = _900 * 1.0549999475479126f;
  float _904 = _901 * 1.0549999475479126f;
  float _905 = _902 * 1.0549999475479126f;
  float _906 = _903 + -0.054999999701976776f;
  float _907 = _904 + -0.054999999701976776f;
  float _908 = _905 + -0.054999999701976776f;
  float _909 = select(_888, _891, _906);
  float _910 = select(_889, _892, _907);
  float _911 = select(_890, _893, _908);
  float _912 = log2(_909);
  float _913 = log2(_910);
  float _914 = log2(_911);
  float _915 = floor(_912);
  float _916 = floor(_913);
  float _917 = floor(_914);
  float _918 = _915 + -6.0f;
  float _919 = _916 + -6.0f;
  float _920 = _917 + -5.0f;
  float _921 = exp2(_918);
  float _922 = exp2(_919);
  float _923 = exp2(_920);
  uint _924 = uint(SV_Position.x);
  uint _925 = uint(SV_Position.y);
  int _926 = _924 & 63;
  int _927 = _925 & 63;
  float4 _928 = sBlueNoiseR8.Load(int4(_926, _927, 0, 0));
  float _930 = _928.x + -0.5f;
  bool _931 = (_909 > 0.0f);
  bool _932 = (_910 > 0.0f);
  bool _933 = (_911 > 0.0f);
  float _934 = float((bool)_931);
  float _935 = float((bool)_932);
  float _936 = float((bool)_933);
  float _937 = _921 * _934;
  float _938 = _937 * _930;
  float _939 = _922 * _935;
  float _940 = _939 * _930;
  float _941 = _923 * _936;
  float _942 = _941 * _930;
  float _943 = _938 + _909;
  float _944 = _940 + _910;
  float _945 = _942 + _911;
  SV_Target.x = _943;
  SV_Target.y = _944;
  SV_Target.z = _945;
  SV_Target.w = _101.w;
