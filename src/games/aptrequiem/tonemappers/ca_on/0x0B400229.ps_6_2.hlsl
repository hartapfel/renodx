...
float4 main(
  ...
  float _234 = APTScaleVignetteMask(exp2(_233));
  ...
  float _1012 = _1009 + -6.0f;
  float _1013 = _1010 + -6.0f;
  float _1014 = _1011 + -5.0f;
  float _1015 = exp2(_1012);
  float _1016 = exp2(_1013);
  float _1017 = exp2(_1014);
  uint _1018 = uint(SV_Position.x);
  uint _1019 = uint(SV_Position.y);
  int _1020 = _1018 & 63;
  int _1021 = _1019 & 63;
  float4 _1022 = sBlueNoiseR8.Load(int4(_1020, _1021, 0, 0));
  float _1024 = _1022.x + -0.5f;
  bool _1025 = (_1003 > 0.0f);
  bool _1026 = (_1004 > 0.0f);
  bool _1027 = (_1005 > 0.0f);
  float _1028 = float((bool)_1025);
  float _1029 = float((bool)_1026);
  float _1030 = float((bool)_1027);
  float _1031 = _1015 * _1028;
  float _1032 = _1031 * _1024;
  float _1033 = _1016 * _1029;
  float _1034 = _1033 * _1024;
  float _1035 = _1017 * _1030;
  float _1036 = _1035 * _1024;
  float _1037 = _1032 + _1003;
  float _1038 = _1034 + _1004;
  float _1039 = _1036 + _1005;
  SV_Target.x = _1037;
  SV_Target.y = _1038;
  SV_Target.z = _1039;
  SV_Target.w = _103.w;
