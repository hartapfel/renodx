...
float4 main(
  ...
  bool _539 = ((User.c[3].x) > 0.0f) && !APTIsPsychoV();
  if (_539) {
  ...
  float3 apt_tonemapped = APTApplyPostProcessToneMap(
      ...
      float3(_1037, _1038, _1039),
      false);
  _1037 = apt_tonemapped.x;
  _1038 = apt_tonemapped.y;
  _1039 = apt_tonemapped.z;
  bool _1040 = (_1037 <= 0.0031308000907301903f);
  bool _1041 = (_1038 <= 0.0031308000907301903f);
  bool _1042 = (_1039 <= 0.0031308000907301903f);
  float _1043 = _1037 * 12.920000076293945f;
  float _1044 = _1038 * 12.920000076293945f;
  float _1045 = _1039 * 12.920000076293945f;
  float _1046 = log2(_1037);
  float _1047 = log2(_1038);
  float _1048 = log2(_1039);
  float _1049 = _1046 * 0.4166666567325592f;
  float _1050 = _1047 * 0.4166666567325592f;
  float _1051 = _1048 * 0.4166666567325592f;
  float _1052 = exp2(_1049);
  float _1053 = exp2(_1050);
  float _1054 = exp2(_1051);
  float _1055 = _1052 * 1.0549999475479126f;
  float _1056 = _1053 * 1.0549999475479126f;
  float _1057 = _1054 * 1.0549999475479126f;
  float _1058 = _1055 + -0.054999999701976776f;
  float _1059 = _1056 + -0.054999999701976776f;
  float _1060 = _1057 + -0.054999999701976776f;
  float _1061 = select(_1040, _1043, _1058);
  float _1062 = select(_1041, _1044, _1059);
  float _1063 = select(_1042, _1045, _1060);
  float _1064 = log2(_1061);
  float _1065 = log2(_1062);
  float _1066 = log2(_1063);
  float _1067 = floor(_1064);
  float _1068 = floor(_1065);
  float _1069 = floor(_1066);
  float _1070 = _1067 + -6.0f;
  float _1071 = _1068 + -6.0f;
  float _1072 = _1069 + -5.0f;
  float _1073 = exp2(_1070);
  float _1074 = exp2(_1071);
  float _1075 = exp2(_1072);
  uint _1076 = uint(SV_Position.x);
  uint _1077 = uint(SV_Position.y);
  int _1078 = _1076 & 63;
  int _1079 = _1077 & 63;
  float4 _1080 = sBlueNoiseR8.Load(int4(_1078, _1079, 0, 0));
  float _1082 = _1080.x + -0.5f;
  bool _1083 = (_1061 > 0.0f);
  bool _1084 = (_1062 > 0.0f);
  bool _1085 = (_1063 > 0.0f);
  float _1086 = float((bool)_1083);
  float _1087 = float((bool)_1084);
  float _1088 = float((bool)_1085);
  float _1089 = _1073 * _1086;
  float _1090 = _1089 * _1082;
  float _1091 = _1074 * _1087;
  float _1092 = _1091 * _1082;
  float _1093 = _1075 * _1088;
  float _1094 = _1093 * _1082;
  float _1095 = _1090 + _1061;
  float _1096 = _1092 + _1062;
  float _1097 = _1094 + _1063;
  SV_Target.x = _1095;
  SV_Target.y = _1096;
  SV_Target.z = _1097;
  SV_Target.w = _112.w;
