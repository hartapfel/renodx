...
float4 main(
  ...
  float3 apt_tonemapped = APTApplyPostProcessToneMap(
      ...
      float3(_990, _991, _992),
      false);
  _990 = apt_tonemapped.x;
  _991 = apt_tonemapped.y;
  _992 = apt_tonemapped.z;
  bool _993 = (_990 <= 0.0031308000907301903f);
  bool _994 = (_991 <= 0.0031308000907301903f);
  bool _995 = (_992 <= 0.0031308000907301903f);
  float _996 = _990 * 12.920000076293945f;
  float _997 = _991 * 12.920000076293945f;
  float _998 = _992 * 12.920000076293945f;
  float _999 = log2(_990);
  float _1000 = log2(_991);
  float _1001 = log2(_992);
  float _1002 = _999 * 0.4166666567325592f;
  float _1003 = _1000 * 0.4166666567325592f;
  float _1004 = _1001 * 0.4166666567325592f;
  ...
  float _1010 = _1007 * 1.0549999475479126f;
  float _1011 = _1008 + -0.054999999701976776f;
  float _1012 = _1009 + -0.054999999701976776f;
  float _1013 = _1010 + -0.054999999701976776f;
  float _1014 = select(_993, _996, _1011);
  float _1015 = select(_994, _997, _1012);
  float _1016 = select(_995, _998, _1013);
  float _1017 = log2(_1014);
  float _1018 = log2(_1015);
  float _1019 = log2(_1016);
  float _1020 = floor(_1017);
  float _1021 = floor(_1018);
  float _1022 = floor(_1019);
  float _1023 = _1020 + -6.0f;
  float _1024 = _1021 + -6.0f;
  float _1025 = _1022 + -5.0f;
  float _1026 = exp2(_1023);
  float _1027 = exp2(_1024);
  float _1028 = exp2(_1025);
  uint _1029 = uint(SV_Position.x);
  uint _1030 = uint(SV_Position.y);
  int _1031 = _1029 & 63;
  int _1032 = _1030 & 63;
  float4 _1033 = sBlueNoiseR8.Load(int4(_1031, _1032, 0, 0));
  float _1035 = _1033.x + -0.5f;
  bool _1036 = (_1014 > 0.0f);
  bool _1037 = (_1015 > 0.0f);
  bool _1038 = (_1016 > 0.0f);
  float _1039 = float((bool)_1036);
  float _1040 = float((bool)_1037);
  float _1041 = float((bool)_1038);
  float _1042 = _1026 * _1039;
  float _1043 = _1042 * _1035;
  float _1044 = _1027 * _1040;
  float _1045 = _1044 * _1035;
  float _1046 = _1028 * _1041;
  float _1047 = _1046 * _1035;
  float _1048 = _1043 + _1014;
  float _1049 = _1045 + _1015;
  float _1050 = _1047 + _1016;
  SV_Target.x = _1048;
  SV_Target.y = _1049;
  SV_Target.z = _1050;
  SV_Target.w = _61.w;
