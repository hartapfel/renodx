...
- Build with `cmake --build --preset vs-x64-release --target aptrequiem` and confirm `embed/shaders.h` registers 36 shaders: one LUT builder, 34 postprocess variants, and one output transform.
