...
float4 main(
  ...
  float _670 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * 1.1190600395202637f;
  ...
  float _682 = (PostProcess_000.PostProcessConstant_Z_320[0].x) * 0.07434873282909393f;
  float _683 = _682 * _677;
  float _684 = _682 * _678;
  float _685 = _682 * _679;
  float _687 = _683 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float _688 = _684 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float _689 = _685 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float4 _692 = t3.Sample(s3, float3(_687, _688, _689));
  ...
  float _707 = 0.8936070799827576f / (PostProcess_000.PostProcessConstant_Z_000[10].w);
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _708 = apt_scaled_lut_output.x;
  _709 = apt_scaled_lut_output.y;
  _710 = apt_scaled_lut_output.z;
  bool _713 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_713) {
    float _715 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * 1.1190600395202637f;
    ...
    int _729 = asint((User_000.UserConstant_Z_000[3].y));
    int _730 = _729 & 1;
    bool _731 = (_730 == 0);
    if (!_731) {
      bool _748 = !(_725 <= (User_000.UserConstant_Z_000[4].x));
      if (!_748) {
        float _750 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        float _751 = _725 / _750;
        float _752 = _751 * (User_000.UserConstant_Z_000[4].y);
        float _753 = _751 * _751;
        float _754 = _753 * _751;
        float _755 = _754 - _751;
        float _756 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _762 = !(_725 <= (User_000.UserConstant_Z_000[4].z));
        if (!_762) {
          float _764 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _765 = max(9.999999974752427e-07f, _764);
          float _766 = _725 - (User_000.UserConstant_Z_000[4].x);
          float _767 = _766 / _765;
          float _768 = 1.0f - _767;
          float _769 = _768 * (User_000.UserConstant_Z_000[4].y);
          float _770 = _767 * (User_000.UserConstant_Z_000[4].w);
          float _771 = _769 + _770;
          float _772 = _768 * _768;
          float _773 = _772 * _768;
          float _774 = _773 - _768;
          float _775 = _774 * (User_000.UserConstant_Z_000[10].x);
          float _776 = _767 * _767;
          float _777 = _776 * _767;
          float _778 = _777 - _767;
          float _779 = _778 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _786 = !(_725 <= (User_000.UserConstant_Z_000[9].x));
          if (!_786) {
            float _788 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _789 = max(9.999999974752427e-07f, _788);
            float _790 = _725 - (User_000.UserConstant_Z_000[4].z);
            float _791 = _790 / _789;
            float _792 = 1.0f - _791;
            float _793 = _792 * (User_000.UserConstant_Z_000[4].w);
            float _794 = _791 * (User_000.UserConstant_Z_000[9].y);
            float _795 = _793 + _794;
            float _796 = _792 * _792;
            float _797 = _796 * _792;
            float _798 = _797 - _792;
            float _799 = _798 * (User_000.UserConstant_Z_000[10].y);
            float _800 = _791 * _791;
            float _801 = _800 * _791;
            float _802 = _801 - _791;
            float _803 = _802 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _810 = !(_725 <= (User_000.UserConstant_Z_000[9].z));
            if (!_810) {
              float _812 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _813 = max(9.999999974752427e-07f, _812);
              float _814 = _725 - (User_000.UserConstant_Z_000[9].x);
              float _815 = _814 / _813;
              float _816 = 1.0f - _815;
              float _817 = _816 * (User_000.UserConstant_Z_000[9].y);
              float _818 = _815 * (User_000.UserConstant_Z_000[9].w);
              float _819 = _817 + _818;
              float _820 = _816 * _816;
              float _821 = _820 * _816;
              float _822 = _821 - _816;
              float _823 = _822 * (User_000.UserConstant_Z_000[10].z);
              float _824 = _815 * _815;
              float _825 = _824 * _815;
              float _826 = _825 - _815;
              float _827 = _826 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _834 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _835 = _725 - (User_000.UserConstant_Z_000[9].z);
              float _836 = max(9.999999974752427e-07f, _834);
              float _837 = _835 / _836;
              float _838 = 1.0f - _837;
              float _839 = _838 * (User_000.UserConstant_Z_000[9].w);
              float _840 = _839 + _837;
              float _841 = _838 * _838;
              float _842 = _841 * _838;
              float _843 = _842 - _838;
              float _844 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
      ...
      bool _852 = !(_726 <= (User_000.UserConstant_Z_000[4].x));
      if (!_852) {
        float _854 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        float _855 = _726 / _854;
        float _856 = _855 * (User_000.UserConstant_Z_000[4].y);
        float _857 = _855 * _855;
        float _858 = _857 * _855;
        float _859 = _858 - _855;
        float _860 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _866 = !(_726 <= (User_000.UserConstant_Z_000[4].z));
        if (!_866) {
          float _868 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _869 = max(9.999999974752427e-07f, _868);
          float _870 = _726 - (User_000.UserConstant_Z_000[4].x);
          float _871 = _870 / _869;
          float _872 = 1.0f - _871;
          float _873 = _872 * (User_000.UserConstant_Z_000[4].y);
          float _874 = _871 * (User_000.UserConstant_Z_000[4].w);
          float _875 = _873 + _874;
          float _876 = _872 * _872;
          float _877 = _876 * _872;
          float _878 = _877 - _872;
          float _879 = _878 * (User_000.UserConstant_Z_000[10].x);
          float _880 = _871 * _871;
          float _881 = _880 * _871;
          float _882 = _881 - _871;
          float _883 = _882 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _890 = !(_726 <= (User_000.UserConstant_Z_000[9].x));
          if (!_890) {
            float _892 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _893 = max(9.999999974752427e-07f, _892);
            float _894 = _726 - (User_000.UserConstant_Z_000[4].z);
            float _895 = _894 / _893;
            float _896 = 1.0f - _895;
            float _897 = _896 * (User_000.UserConstant_Z_000[4].w);
            float _898 = _895 * (User_000.UserConstant_Z_000[9].y);
            float _899 = _897 + _898;
            float _900 = _896 * _896;
            float _901 = _900 * _896;
            float _902 = _901 - _896;
            float _903 = _902 * (User_000.UserConstant_Z_000[10].y);
            float _904 = _895 * _895;
            float _905 = _904 * _895;
            float _906 = _905 - _895;
            float _907 = _906 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _914 = !(_726 <= (User_000.UserConstant_Z_000[9].z));
            if (!_914) {
              float _916 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _917 = max(9.999999974752427e-07f, _916);
              float _918 = _726 - (User_000.UserConstant_Z_000[9].x);
              float _919 = _918 / _917;
              float _920 = 1.0f - _919;
              float _921 = _920 * (User_000.UserConstant_Z_000[9].y);
              float _922 = _919 * (User_000.UserConstant_Z_000[9].w);
              float _923 = _921 + _922;
              float _924 = _920 * _920;
              float _925 = _924 * _920;
              float _926 = _925 - _920;
              float _927 = _926 * (User_000.UserConstant_Z_000[10].z);
              float _928 = _919 * _919;
              float _929 = _928 * _919;
              float _930 = _929 - _919;
              float _931 = _930 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _938 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _939 = _726 - (User_000.UserConstant_Z_000[9].z);
              float _940 = max(9.999999974752427e-07f, _938);
              float _941 = _939 / _940;
              float _942 = 1.0f - _941;
              float _943 = _942 * (User_000.UserConstant_Z_000[9].w);
              float _944 = _943 + _941;
              float _945 = _942 * _942;
              float _946 = _945 * _942;
              float _947 = _946 - _942;
              float _948 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
      ...
      bool _956 = !(_727 <= (User_000.UserConstant_Z_000[4].x));
      if (!_956) {
        float _958 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        float _959 = _727 / _958;
        float _960 = _959 * (User_000.UserConstant_Z_000[4].y);
        float _961 = _959 * _959;
        float _962 = _961 * _959;
        float _963 = _962 - _959;
        float _964 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _970 = !(_727 <= (User_000.UserConstant_Z_000[4].z));
        if (!_970) {
          float _972 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _973 = max(9.999999974752427e-07f, _972);
          float _974 = _727 - (User_000.UserConstant_Z_000[4].x);
          float _975 = _974 / _973;
          float _976 = 1.0f - _975;
          float _977 = _976 * (User_000.UserConstant_Z_000[4].y);
          float _978 = _975 * (User_000.UserConstant_Z_000[4].w);
          float _979 = _977 + _978;
          float _980 = _976 * _976;
          float _981 = _980 * _976;
          float _982 = _981 - _976;
          float _983 = _982 * (User_000.UserConstant_Z_000[10].x);
          float _984 = _975 * _975;
          float _985 = _984 * _975;
          float _986 = _985 - _975;
          float _987 = _986 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _994 = !(_727 <= (User_000.UserConstant_Z_000[9].x));
          if (!_994) {
            float _996 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _997 = max(9.999999974752427e-07f, _996);
            float _998 = _727 - (User_000.UserConstant_Z_000[4].z);
            float _999 = _998 / _997;
            float _1000 = 1.0f - _999;
            float _1001 = _1000 * (User_000.UserConstant_Z_000[4].w);
            float _1002 = _999 * (User_000.UserConstant_Z_000[9].y);
            float _1003 = _1001 + _1002;
            float _1004 = _1000 * _1000;
            float _1005 = _1004 * _1000;
            float _1006 = _1005 - _1000;
            float _1007 = _1006 * (User_000.UserConstant_Z_000[10].y);
            float _1008 = _999 * _999;
            float _1009 = _1008 * _999;
            float _1010 = _1009 - _999;
            float _1011 = _1010 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _1018 = !(_727 <= (User_000.UserConstant_Z_000[9].z));
            if (!_1018) {
              float _1020 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _1021 = max(9.999999974752427e-07f, _1020);
              float _1022 = _727 - (User_000.UserConstant_Z_000[9].x);
              float _1023 = _1022 / _1021;
              float _1024 = 1.0f - _1023;
              float _1025 = _1024 * (User_000.UserConstant_Z_000[9].y);
              float _1026 = _1023 * (User_000.UserConstant_Z_000[9].w);
              float _1027 = _1025 + _1026;
              float _1028 = _1024 * _1024;
              float _1029 = _1028 * _1024;
              float _1030 = _1029 - _1024;
              float _1031 = _1030 * (User_000.UserConstant_Z_000[10].z);
              float _1032 = _1023 * _1023;
              float _1033 = _1032 * _1023;
              float _1034 = _1033 - _1023;
              float _1035 = _1034 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _1042 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _1043 = _727 - (User_000.UserConstant_Z_000[9].z);
              float _1044 = max(9.999999974752427e-07f, _1042);
              float _1045 = _1043 / _1044;
              float _1046 = 1.0f - _1045;
              float _1047 = _1046 * (User_000.UserConstant_Z_000[9].w);
              float _1048 = _1047 + _1045;
              float _1049 = _1046 * _1046;
              float _1050 = _1049 * _1046;
              float _1051 = _1050 - _1046;
              float _1052 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
    ...
    if (_1076) {
      ...
      if (!_1079) {
        ...
        bool _1082 = (_1081 == 0);
        if (!_1082) {
          float _1086 = (User_000.UserConstant_Z_000[5].x) * 0.5f;
          float _1087 = _1086 + 0.5f;
          bool _1088 = (_1087 < 0.5f);
          float _1089 = (User_000.UserConstant_Z_000[5].x) * 5.0f;
          float _1090 = select(_1088, (User_000.UserConstant_Z_000[5].x), _1089);
          ...
          float _1102 = _1100 - (User_000.UserConstant_Z_000[5].y);
          ...
          float _1110 = 1.0f - (User_000.UserConstant_Z_000[5].z);
          ...
          if (!_1133) {
            float _1137 = abs(User_000.UserConstant_Z_000[5].x);
            float _1138 = saturate(_1137);
            uint4 _1140 = 0u; t15.GetDimensions(0u, _1140.x, _1140.y, _1140.w);
            ...
            if (!_1145) {
              ...
              int _1151 = _1149 & 63;
              int _1152 = _1150 & 63;
              float4 _1154 = t6.Load(int4(_1151, _1152, 0, 0));
            ...
            float4 _1220 = t15.Sample(s0, float2(_1215, _1210));
            float4 _1224 = t15.Sample(s0, float2(_1218, _1210));
  ...
  float _1271 = (User_000.UserConstant_Z_000[8].x) * _1264;
  float _1272 = (User_000.UserConstant_Z_000[8].y) * _1265;
  float _1273 = (User_000.UserConstant_Z_000[8].z) * _1266;
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      float3(_1271, _1272, _1273),
      SV_Position.xy);
  float _1278 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * TEXCOORD.x;
  float _1279 = _1278 * (PostProcess_000.PostProcessConstant_Z_000[9].x);
  float _1280 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * TEXCOORD.y;
  float _1281 = _1280 * (PostProcess_000.PostProcessConstant_Z_000[9].y);
  float _1284 = _1279 + (PostProcess_000.PostProcessConstant_Z_000[9].z);
  float _1285 = _1281 + (PostProcess_000.PostProcessConstant_Z_000[9].w);
  float4 _1288 = t9.Sample(s9, float2(_1284, _1285));
  float _1292 = dot(float3(_1271, _1272, _1273), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
  bool _1295 = ((PostProcess_000.PostProcessConstant_Z_000[10].x) > 0.0f);
  int _1298 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  int _1299 = select(_1295, _1298, 0);
  float _1300 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * SV_Position.x;
  float _1301 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * SV_Position.y;
  uint _1302 = uint(_1300);
  uint _1303 = uint(_1301);
  int _1304 = _1302 & 63;
  int _1305 = _1303 & 63;
  float4 _1307 = t6.Load(int4(_1304, _1305, _1299, 0));
  bool _1309 = ((PostProcess_000.PostProcessConstant_Z_000[10].z) < 1.0f);
  if (_1309) {
    float _1311 = _1300 * 0.015625f;
    float _1312 = _1301 * 0.015625f;
    float _1313 = float((uint)_1298);
    float _1314 = select(_1295, _1313, 0.0f);
    float4 _1316 = t6.SampleLevel(s1, float3(_1311, _1312, _1314), 0.0f);
    float _1318 = _1307.y - _1316.y;
    float _1319 = _1318 * (PostProcess_000.PostProcessConstant_Z_000[10].z);
  ...
  bool _1344 = ((PostProcess_000.PostProcessConstant_Z_000[10].y) > 0.0f);
  ...
  float _1359 = (PostProcess_000.PostProcessConstant_Z_000[2].y) - (PostProcess_000.PostProcessConstant_Z_000[2].x);
  float _1360 = _1359 * _1335;
  float _1361 = _1360 + (PostProcess_000.PostProcessConstant_Z_000[2].x);
  ...
  _1369 = apt_film_grain_output.x;
  _1370 = apt_film_grain_output.y;
  _1371 = apt_film_grain_output.z;
  float _1374 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
  ...
  float _1384 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  ...
  float _1396 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1411 = apt_post_process_output.x;
  float _1412 = apt_post_process_output.y;
  float _1413 = apt_post_process_output.z;
  ...
  int _1440 = _1438 & 63;
  int _1441 = _1439 & 63;
  float4 _1443 = t1.Load(int4(_1440, _1441, _1298, 0));
