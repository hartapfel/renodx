...
float4 main(
  ...
  float _706 = _699 * (User_000.UserConstant_Z_000[4].x);
  float _707 = _700 * (User_000.UserConstant_Z_000[4].y);
  float _708 = _701 * (User_000.UserConstant_Z_000[4].z);
  ...
  _706 = apt_scaled_lut_output.x;
  _707 = apt_scaled_lut_output.y;
  _708 = apt_scaled_lut_output.z;
  bool _711 = !((PostProcess_000.PostProcessConstant_Z_000[17].x) == 0.0f) && !APTIsPsychoV();
  if (_711) {
    float _721 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _706;
    float _722 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _707;
    float _723 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * _708;
    bool _724 = (_721 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_724) {
      float _726 = _721 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _727 = 1.0f - _726;
      float _728 = _727 * _727;
      float _729 = _728 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _730 = _729 + _721;
      _732 = _730;
    } else {
      _732 = _721;
    }
    bool _733 = (_722 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_733) {
      float _735 = _722 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _736 = 1.0f - _735;
      float _737 = _736 * _736;
      float _738 = _737 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _739 = _738 + _722;
      _741 = _739;
    } else {
      _741 = _722;
    }
    bool _742 = (_723 < (PostProcess_000.PostProcessConstant_Z_000[16].z));
    if (_742) {
      float _744 = _723 / (PostProcess_000.PostProcessConstant_Z_000[16].z);
      float _745 = 1.0f - _744;
      float _746 = _745 * _745;
      float _747 = _746 * (PostProcess_000.PostProcessConstant_Z_000[15].w);
      float _748 = _747 + _723;
      _750 = _748;
    } else {
      _750 = _723;
    }
    float _751 = _732 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _752 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
    float _753 = log2(_751);
    float _754 = _753 * _752;
    float _755 = exp2(_754);
    float _756 = _755 + -1.0f;
    float _757 = _751 + -1.0f;
    float _758 = _756 / _757;
    bool _759 = !(_751 == 1.0f);
    float _760 = _758 + -1.0f;
    float _761 = _760 / _758;
    float _762 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _763 = _762 / _752;
    float _764 = select(_759, _761, _763);
    float _765 = _764 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _766 = _741 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _767 = log2(_766);
    float _768 = _767 * _752;
    float _769 = exp2(_768);
    float _770 = _769 + -1.0f;
    float _771 = _766 + -1.0f;
    float _772 = _770 / _771;
    bool _773 = !(_766 == 1.0f);
    float _774 = _772 + -1.0f;
    float _775 = _774 / _772;
    float _776 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _777 = _776 / _752;
    float _778 = select(_773, _775, _777);
    float _779 = _778 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _780 = _750 / (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _781 = log2(_780);
    float _782 = _781 * _752;
    float _783 = exp2(_782);
    float _784 = _783 + -1.0f;
    float _785 = _780 + -1.0f;
    float _786 = _784 / _785;
    bool _787 = !(_780 == 1.0f);
    float _788 = _786 + -1.0f;
    float _789 = _788 / _786;
    float _790 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
    float _791 = _790 / _752;
    float _792 = select(_787, _789, _791);
    float _793 = _792 * (PostProcess_000.PostProcessConstant_Z_000[16].x);
    float _794 = _765 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _795 = _779 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    float _796 = _793 / (PostProcess_000.PostProcessConstant_Z_000[10].w);
    _798 = _794;
    _799 = _795;
    _800 = _796;
  } else {
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      float3(_706, _707, _708),
      float3(_798, _799, _800),
      false);
  _798 = apt_post_process_output.x;
  _799 = apt_post_process_output.y;
  _800 = apt_post_process_output.z;
  float _801 = log2(_798);
  float _802 = log2(_799);
  float _803 = log2(_800);
  float _804 = _801 * 0.4166666567325592f;
  ...
  float _810 = _807 * 1.0549999475479126f;
  float _811 = _808 * 1.0549999475479126f;
  float _812 = _809 * 1.0549999475479126f;
  float _813 = _810 + -0.054999999701976776f;
  float _814 = _811 + -0.054999999701976776f;
  float _815 = _812 + -0.054999999701976776f;
  float _816 = _798 * 12.920000076293945f;
  float _817 = _799 * 12.920000076293945f;
  float _818 = _800 * 12.920000076293945f;
  bool _819 = (_798 <= 0.0031308000907301903f);
  bool _820 = (_799 <= 0.0031308000907301903f);
  bool _821 = (_800 <= 0.0031308000907301903f);
  float _822 = select(_819, _816, _813);
  float _823 = select(_820, _817, _814);
  float _824 = select(_821, _818, _815);
  ...
  float _831 = _828 + -6.0f;
  float _832 = _829 + -6.0f;
  float _833 = _830 + -5.0f;
  float _834 = exp2(_831);
  float _835 = exp2(_832);
  float _836 = exp2(_833);
  bool _837 = (_822 <= 0.0f);
  bool _838 = (_823 <= 0.0f);
  bool _839 = (_824 <= 0.0f);
  float _840 = select(_837, 0.0f, _834);
  float _841 = select(_838, 0.0f, _835);
  float _842 = select(_839, 0.0f, _836);
  int _845 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  uint _846 = uint(SV_Position.x);
  uint _847 = uint(SV_Position.y);
  int _848 = _846 & 63;
  int _849 = _847 & 63;
  float4 _851 = t1.Load(int4(_848, _849, _845, 0));
  float4 _854 = t6.Load(int4(_848, _849, _845, 0));
  float _857 = _851.x * _840;
  float _858 = _854.x * _841;
  float _859 = _854.y * _842;
  float _860 = _857 + _822;
  float _861 = _858 + _823;
