...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _633 = apt_scaled_lut_output.x;
  _634 = apt_scaled_lut_output.y;
  _635 = apt_scaled_lut_output.z;
  bool _638 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_638) {
  ...
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1198 = apt_perceptual_film_grain.x;
  ...
  float _1212 = apt_perceptual_film_grain.y;
  ...
  float _1225 = apt_perceptual_film_grain.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1238 = apt_post_process_output.x;
  float _1239 = apt_post_process_output.y;
  float _1240 = apt_post_process_output.z;
