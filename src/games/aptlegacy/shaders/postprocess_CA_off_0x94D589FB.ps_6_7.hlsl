...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _819 = apt_scaled_lut_output.x;
  _820 = apt_scaled_lut_output.y;
  _821 = apt_scaled_lut_output.z;
  bool _824 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_824) {
  ...
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1384 = apt_perceptual_film_grain.x;
  ...
  float _1398 = apt_perceptual_film_grain.y;
  ...
  float _1411 = apt_perceptual_film_grain.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1424 = apt_post_process_output.x;
  float _1425 = apt_post_process_output.y;
  float _1426 = apt_post_process_output.z;
