...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _510 = apt_scaled_lut_output.x;
  _511 = apt_scaled_lut_output.y;
  _512 = apt_scaled_lut_output.z;
  bool _515 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_515) {
  ...
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1075 = apt_perceptual_film_grain.x;
  ...
  float _1089 = apt_perceptual_film_grain.y;
  ...
  float _1102 = apt_perceptual_film_grain.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1115 = apt_post_process_output.x;
  float _1116 = apt_post_process_output.y;
  float _1117 = apt_post_process_output.z;
