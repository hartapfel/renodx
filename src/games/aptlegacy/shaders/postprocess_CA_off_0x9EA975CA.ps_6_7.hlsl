...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _513 = apt_scaled_lut_output.x;
  _514 = apt_scaled_lut_output.y;
  _515 = apt_scaled_lut_output.z;
  bool _518 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_518) {
  ...
  _1174 = apt_film_grain_output.x;
  _1175 = apt_film_grain_output.y;
  _1176 = apt_film_grain_output.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1216 = apt_post_process_output.x;
  float _1217 = apt_post_process_output.y;
  float _1218 = apt_post_process_output.z;
