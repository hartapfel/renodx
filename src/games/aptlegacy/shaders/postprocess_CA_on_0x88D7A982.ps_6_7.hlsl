...
float4 main(
  ...
  float _236 = _230.x * (Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[87].y);
  ...
  float _253 = (PostProcess_000.PostProcessConstant_Z_000[13].w) * _250;
  float _254 = _249 * _249;
  float _255 = _253 * _253;
  float _256 = _255 + _254;
  float _257 = sqrt(_256);
  float _259 = (PostProcess_000.PostProcessConstant_Z_000[13].x) * _257;
  float _261 = _259 + (PostProcess_000.PostProcessConstant_Z_000[13].y);
  float _262 = saturate(_261);
  float _264 = log2(_262);
  float _265 = _264 * (PostProcess_000.PostProcessConstant_Z_000[13].z);
  float _266 = exp2(_265);
  float _267 = _238 * (PostProcess_000.PostProcessConstant_Z_000[12].x);
  float _268 = _240 * (PostProcess_000.PostProcessConstant_Z_000[12].y);
  float _269 = _242 * (PostProcess_000.PostProcessConstant_Z_000[12].z);
  ...
  float _281 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * 1.1190600395202637f;
  ...
  float _293 = (PostProcess_000.PostProcessConstant_Z_320[0].x) * 0.07434873282909393f;
  float _294 = _293 * _288;
  float _295 = _293 * _289;
  float _296 = _293 * _290;
  float _298 = _294 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float _299 = _295 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float _300 = _296 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float4 _303 = t3.Sample(s3, float3(_298, _299, _300));
  ...
  float _318 = 0.8936070799827576f / (PostProcess_000.PostProcessConstant_Z_000[10].w);
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _319 = apt_scaled_lut_output.x;
  _320 = apt_scaled_lut_output.y;
  _321 = apt_scaled_lut_output.z;
  bool _324 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_324) {
    float _326 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * 1.1190600395202637f;
    ...
    int _340 = asint((User_000.UserConstant_Z_000[3].y));
    int _341 = _340 & 1;
    bool _342 = (_341 == 0);
    if (!_342) {
      bool _359 = !(_336 <= (User_000.UserConstant_Z_000[4].x));
      if (!_359) {
        float _361 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        float _362 = _336 / _361;
        float _363 = _362 * (User_000.UserConstant_Z_000[4].y);
        float _364 = _362 * _362;
        float _365 = _364 * _362;
        float _366 = _365 - _362;
        float _367 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _373 = !(_336 <= (User_000.UserConstant_Z_000[4].z));
        if (!_373) {
          float _375 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _376 = max(9.999999974752427e-07f, _375);
          float _377 = _336 - (User_000.UserConstant_Z_000[4].x);
          float _378 = _377 / _376;
          float _379 = 1.0f - _378;
          float _380 = _379 * (User_000.UserConstant_Z_000[4].y);
          float _381 = _378 * (User_000.UserConstant_Z_000[4].w);
          float _382 = _380 + _381;
          float _383 = _379 * _379;
          float _384 = _383 * _379;
          float _385 = _384 - _379;
          float _386 = _385 * (User_000.UserConstant_Z_000[10].x);
          float _387 = _378 * _378;
          float _388 = _387 * _378;
          float _389 = _388 - _378;
          float _390 = _389 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _397 = !(_336 <= (User_000.UserConstant_Z_000[9].x));
          if (!_397) {
            float _399 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _400 = max(9.999999974752427e-07f, _399);
            float _401 = _336 - (User_000.UserConstant_Z_000[4].z);
            float _402 = _401 / _400;
            float _403 = 1.0f - _402;
            float _404 = _403 * (User_000.UserConstant_Z_000[4].w);
            float _405 = _402 * (User_000.UserConstant_Z_000[9].y);
            float _406 = _404 + _405;
            float _407 = _403 * _403;
            float _408 = _407 * _403;
            float _409 = _408 - _403;
            float _410 = _409 * (User_000.UserConstant_Z_000[10].y);
            float _411 = _402 * _402;
            float _412 = _411 * _402;
            float _413 = _412 - _402;
            float _414 = _413 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _421 = !(_336 <= (User_000.UserConstant_Z_000[9].z));
            if (!_421) {
              float _423 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _424 = max(9.999999974752427e-07f, _423);
              float _425 = _336 - (User_000.UserConstant_Z_000[9].x);
              float _426 = _425 / _424;
              float _427 = 1.0f - _426;
              float _428 = _427 * (User_000.UserConstant_Z_000[9].y);
              float _429 = _426 * (User_000.UserConstant_Z_000[9].w);
              float _430 = _428 + _429;
              float _431 = _427 * _427;
              float _432 = _431 * _427;
              float _433 = _432 - _427;
              float _434 = _433 * (User_000.UserConstant_Z_000[10].z);
              float _435 = _426 * _426;
              float _436 = _435 * _426;
              float _437 = _436 - _426;
              float _438 = _437 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _445 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _446 = _336 - (User_000.UserConstant_Z_000[9].z);
              float _447 = max(9.999999974752427e-07f, _445);
              float _448 = _446 / _447;
              float _449 = 1.0f - _448;
              float _450 = _449 * (User_000.UserConstant_Z_000[9].w);
              float _451 = _450 + _448;
              float _452 = _449 * _449;
              float _453 = _452 * _449;
              float _454 = _453 - _449;
              float _455 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
      ...
      bool _463 = !(_337 <= (User_000.UserConstant_Z_000[4].x));
      if (!_463) {
        float _465 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        float _466 = _337 / _465;
        float _467 = _466 * (User_000.UserConstant_Z_000[4].y);
        float _468 = _466 * _466;
        float _469 = _468 * _466;
        float _470 = _469 - _466;
        float _471 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _477 = !(_337 <= (User_000.UserConstant_Z_000[4].z));
        if (!_477) {
          float _479 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _480 = max(9.999999974752427e-07f, _479);
          float _481 = _337 - (User_000.UserConstant_Z_000[4].x);
          float _482 = _481 / _480;
          float _483 = 1.0f - _482;
          float _484 = _483 * (User_000.UserConstant_Z_000[4].y);
          float _485 = _482 * (User_000.UserConstant_Z_000[4].w);
          float _486 = _484 + _485;
          float _487 = _483 * _483;
          float _488 = _487 * _483;
          float _489 = _488 - _483;
          float _490 = _489 * (User_000.UserConstant_Z_000[10].x);
          float _491 = _482 * _482;
          float _492 = _491 * _482;
          float _493 = _492 - _482;
          float _494 = _493 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _501 = !(_337 <= (User_000.UserConstant_Z_000[9].x));
          if (!_501) {
            float _503 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _504 = max(9.999999974752427e-07f, _503);
            float _505 = _337 - (User_000.UserConstant_Z_000[4].z);
            float _506 = _505 / _504;
            float _507 = 1.0f - _506;
            float _508 = _507 * (User_000.UserConstant_Z_000[4].w);
            float _509 = _506 * (User_000.UserConstant_Z_000[9].y);
            float _510 = _508 + _509;
            float _511 = _507 * _507;
            float _512 = _511 * _507;
            float _513 = _512 - _507;
            float _514 = _513 * (User_000.UserConstant_Z_000[10].y);
            float _515 = _506 * _506;
            float _516 = _515 * _506;
            float _517 = _516 - _506;
            float _518 = _517 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _525 = !(_337 <= (User_000.UserConstant_Z_000[9].z));
            if (!_525) {
              float _527 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _528 = max(9.999999974752427e-07f, _527);
              float _529 = _337 - (User_000.UserConstant_Z_000[9].x);
              float _530 = _529 / _528;
              float _531 = 1.0f - _530;
              float _532 = _531 * (User_000.UserConstant_Z_000[9].y);
              float _533 = _530 * (User_000.UserConstant_Z_000[9].w);
              float _534 = _532 + _533;
              float _535 = _531 * _531;
              float _536 = _535 * _531;
              float _537 = _536 - _531;
              float _538 = _537 * (User_000.UserConstant_Z_000[10].z);
              float _539 = _530 * _530;
              float _540 = _539 * _530;
              float _541 = _540 - _530;
              float _542 = _541 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _549 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _550 = _337 - (User_000.UserConstant_Z_000[9].z);
              float _551 = max(9.999999974752427e-07f, _549);
              float _552 = _550 / _551;
              float _553 = 1.0f - _552;
              float _554 = _553 * (User_000.UserConstant_Z_000[9].w);
              float _555 = _554 + _552;
              float _556 = _553 * _553;
              float _557 = _556 * _553;
              float _558 = _557 - _553;
              float _559 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
      ...
      bool _567 = !(_338 <= (User_000.UserConstant_Z_000[4].x));
      if (!_567) {
        float _569 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        ...
        float _575 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _581 = !(_338 <= (User_000.UserConstant_Z_000[4].z));
        if (!_581) {
          float _583 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _584 = max(9.999999974752427e-07f, _583);
          float _585 = _338 - (User_000.UserConstant_Z_000[4].x);
          float _586 = _585 / _584;
          float _587 = 1.0f - _586;
          float _588 = _587 * (User_000.UserConstant_Z_000[4].y);
          float _589 = _586 * (User_000.UserConstant_Z_000[4].w);
          float _590 = _588 + _589;
          float _591 = _587 * _587;
          float _592 = _591 * _587;
          float _593 = _592 - _587;
          float _594 = _593 * (User_000.UserConstant_Z_000[10].x);
          float _595 = _586 * _586;
          float _596 = _595 * _586;
          float _597 = _596 - _586;
          float _598 = _597 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _605 = !(_338 <= (User_000.UserConstant_Z_000[9].x));
          if (!_605) {
            float _607 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _608 = max(9.999999974752427e-07f, _607);
            float _609 = _338 - (User_000.UserConstant_Z_000[4].z);
            float _610 = _609 / _608;
            float _611 = 1.0f - _610;
            float _612 = _611 * (User_000.UserConstant_Z_000[4].w);
            float _613 = _610 * (User_000.UserConstant_Z_000[9].y);
            float _614 = _612 + _613;
            float _615 = _611 * _611;
            float _616 = _615 * _611;
            float _617 = _616 - _611;
            float _618 = _617 * (User_000.UserConstant_Z_000[10].y);
            float _619 = _610 * _610;
            float _620 = _619 * _610;
            float _621 = _620 - _610;
            float _622 = _621 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _629 = !(_338 <= (User_000.UserConstant_Z_000[9].z));
            if (!_629) {
              float _631 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _632 = max(9.999999974752427e-07f, _631);
              float _633 = _338 - (User_000.UserConstant_Z_000[9].x);
              float _634 = _633 / _632;
              float _635 = 1.0f - _634;
              float _636 = _635 * (User_000.UserConstant_Z_000[9].y);
              float _637 = _634 * (User_000.UserConstant_Z_000[9].w);
              float _638 = _636 + _637;
              float _639 = _635 * _635;
              float _640 = _639 * _635;
              float _641 = _640 - _635;
              float _642 = _641 * (User_000.UserConstant_Z_000[10].z);
              float _643 = _634 * _634;
              float _644 = _643 * _634;
              float _645 = _644 - _634;
              float _646 = _645 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _653 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _654 = _338 - (User_000.UserConstant_Z_000[9].z);
              float _655 = max(9.999999974752427e-07f, _653);
              float _656 = _654 / _655;
              float _657 = 1.0f - _656;
              float _658 = _657 * (User_000.UserConstant_Z_000[9].w);
              float _659 = _658 + _656;
              float _660 = _657 * _657;
              float _661 = _660 * _657;
              float _662 = _661 - _657;
              float _663 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
    ...
    if (_687) {
      ...
      if (!_690) {
        ...
        bool _693 = (_692 == 0);
        if (!_693) {
          float _697 = (User_000.UserConstant_Z_000[5].x) * 0.5f;
          float _698 = _697 + 0.5f;
          bool _699 = (_698 < 0.5f);
          float _700 = (User_000.UserConstant_Z_000[5].x) * 5.0f;
          float _701 = select(_699, (User_000.UserConstant_Z_000[5].x), _700);
          bool _702 = (_673 < _674);
          ...
          float _713 = _711 - (User_000.UserConstant_Z_000[5].y);
          ...
          float _721 = 1.0f - (User_000.UserConstant_Z_000[5].z);
          ...
          bool _744 = (_685 == 0.0f);
          if (!_744) {
            float _748 = abs(User_000.UserConstant_Z_000[5].x);
            float _749 = saturate(_748);
            uint4 _751 = 0u; t15.GetDimensions(0u, _751.x, _751.y, _751.w);
            ...
            if (!_756) {
              ...
              int _762 = _760 & 63;
              int _763 = _761 & 63;
              float4 _765 = t2.Load(int4(_762, _763, 0, 0));
            ...
            float4 _831 = t15.Sample(s0, float2(_826, _821));
            float4 _835 = t15.Sample(s0, float2(_829, _821));
  ...
  float _882 = (User_000.UserConstant_Z_000[8].x) * _875;
  float _883 = (User_000.UserConstant_Z_000[8].y) * _876;
  float _884 = (User_000.UserConstant_Z_000[8].z) * _877;
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      float3(_882, _883, _884),
      SV_Position.xy);
  float _889 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * TEXCOORD.x;
  float _890 = _889 * (PostProcess_000.PostProcessConstant_Z_000[9].x);
  float _891 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * TEXCOORD.y;
  float _892 = _891 * (PostProcess_000.PostProcessConstant_Z_000[9].y);
  float _895 = _890 + (PostProcess_000.PostProcessConstant_Z_000[9].z);
  float _896 = _892 + (PostProcess_000.PostProcessConstant_Z_000[9].w);
  float4 _899 = t9.Sample(s9, float2(_895, _896));
  float _903 = dot(float3(_882, _883, _884), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
  bool _906 = ((PostProcess_000.PostProcessConstant_Z_000[10].x) > 0.0f);
  int _909 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  int _910 = select(_906, _909, 0);
  float _911 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * SV_Position.x;
  float _912 = (PostProcess_000.PostProcessConstant_Z_000[10].z) * SV_Position.y;
  uint _913 = uint(_911);
  uint _914 = uint(_912);
  int _915 = _913 & 63;
  int _916 = _914 & 63;
  float4 _918 = t2.Load(int4(_915, _916, _910, 0));
  bool _920 = ((PostProcess_000.PostProcessConstant_Z_000[10].z) < 1.0f);
  if (_920) {
    float _922 = _911 * 0.015625f;
    float _923 = _912 * 0.015625f;
    float _924 = float((uint)_909);
    float _925 = select(_906, _924, 0.0f);
    float4 _927 = t2.SampleLevel(s1, float3(_922, _923, _925), 0.0f);
    float _929 = _918.y - _927.y;
    float _930 = _929 * (PostProcess_000.PostProcessConstant_Z_000[10].z);
  ...
  bool _955 = ((PostProcess_000.PostProcessConstant_Z_000[10].y) > 0.0f);
  ...
  float _970 = (PostProcess_000.PostProcessConstant_Z_000[2].y) - (PostProcess_000.PostProcessConstant_Z_000[2].x);
  float _971 = _970 * _946;
  float _972 = _971 + (PostProcess_000.PostProcessConstant_Z_000[2].x);
  ...
  _980 = apt_film_grain_output.x;
  _981 = apt_film_grain_output.y;
  _982 = apt_film_grain_output.z;
  float _985 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
  ...
  float _995 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  ...
  float _1007 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  ...
  float _1019 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1022 = apt_post_process_output.x;
  float _1023 = apt_post_process_output.y;
  float _1024 = apt_post_process_output.z;
  ...
  int _1051 = _1049 & 63;
  int _1052 = _1050 & 63;
  float4 _1054 = t1.Load(int4(_1051, _1052, _909, 0));
