...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _269 = apt_scaled_lut_output.x;
  _270 = apt_scaled_lut_output.y;
  _271 = apt_scaled_lut_output.z;
  bool _274 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_274) {
  ...
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _834 = apt_perceptual_film_grain.x;
  ...
  float _848 = apt_perceptual_film_grain.y;
  ...
  float _861 = apt_perceptual_film_grain.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _874 = apt_post_process_output.x;
  float _875 = apt_post_process_output.y;
  float _876 = apt_post_process_output.z;
