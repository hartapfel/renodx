...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _583 = apt_scaled_lut_output.x;
  _584 = apt_scaled_lut_output.y;
  _585 = apt_scaled_lut_output.z;
  bool _588 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_588) {
  ...
  _1244 = apt_film_grain_output.x;
  _1245 = apt_film_grain_output.y;
  _1246 = apt_film_grain_output.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1286 = apt_post_process_output.x;
  float _1287 = apt_post_process_output.y;
  float _1288 = apt_post_process_output.z;
