...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _676 = apt_scaled_lut_output.x;
  _677 = apt_scaled_lut_output.y;
  _678 = apt_scaled_lut_output.z;
  bool _681 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_681) {
  ...
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1241 = apt_perceptual_film_grain.x;
  ...
  float _1255 = apt_perceptual_film_grain.y;
  ...
  float _1268 = apt_perceptual_film_grain.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1281 = apt_post_process_output.x;
  float _1282 = apt_post_process_output.y;
  float _1283 = apt_post_process_output.z;
