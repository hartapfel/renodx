...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _673 = apt_scaled_lut_output.x;
  _674 = apt_scaled_lut_output.y;
  _675 = apt_scaled_lut_output.z;
  bool _678 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_678) {
  ...
  _1334 = apt_film_grain_output.x;
  _1335 = apt_film_grain_output.y;
  _1336 = apt_film_grain_output.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1376 = apt_post_process_output.x;
  float _1377 = apt_post_process_output.y;
  float _1378 = apt_post_process_output.z;
