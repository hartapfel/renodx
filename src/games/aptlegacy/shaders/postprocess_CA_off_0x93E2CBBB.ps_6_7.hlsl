...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _874 = apt_scaled_lut_output.x;
  _875 = apt_scaled_lut_output.y;
  _876 = apt_scaled_lut_output.z;
  bool _879 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_879) {
  ...
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1439 = apt_perceptual_film_grain.x;
  ...
  float _1453 = apt_perceptual_film_grain.y;
  ...
  float _1466 = apt_perceptual_film_grain.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1479 = apt_post_process_output.x;
  float _1480 = apt_post_process_output.y;
  float _1481 = apt_post_process_output.z;
