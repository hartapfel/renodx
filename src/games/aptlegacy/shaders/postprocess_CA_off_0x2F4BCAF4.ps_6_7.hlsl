...
float4 main(
  ...
  float _816 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * 1.1190600395202637f;
  ...
  float _828 = (PostProcess_000.PostProcessConstant_Z_320[0].x) * 0.07434873282909393f;
  float _829 = _828 * _823;
  float _830 = _828 * _824;
  float _831 = _828 * _825;
  float _833 = _829 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float _834 = _830 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float _835 = _831 + (PostProcess_000.PostProcessConstant_Z_320[0].y);
  float4 _838 = t3.Sample(s3, float3(_833, _834, _835));
  ...
  float _853 = 0.8936070799827576f / (PostProcess_000.PostProcessConstant_Z_000[10].w);
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _854 = apt_scaled_lut_output.x;
  _855 = apt_scaled_lut_output.y;
  _856 = apt_scaled_lut_output.z;
  bool _859 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_859) {
    float _861 = (PostProcess_000.PostProcessConstant_Z_000[10].w) * 1.1190600395202637f;
    ...
    int _875 = asint((User_000.UserConstant_Z_000[3].y));
    int _876 = _875 & 1;
    bool _877 = (_876 == 0);
    if (!_877) {
      bool _894 = !(_871 <= (User_000.UserConstant_Z_000[4].x));
      if (!_894) {
        float _896 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        float _897 = _871 / _896;
        float _898 = _897 * (User_000.UserConstant_Z_000[4].y);
        float _899 = _897 * _897;
        float _900 = _899 * _897;
        float _901 = _900 - _897;
        float _902 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _908 = !(_871 <= (User_000.UserConstant_Z_000[4].z));
        if (!_908) {
          float _910 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _911 = max(9.999999974752427e-07f, _910);
          float _912 = _871 - (User_000.UserConstant_Z_000[4].x);
          float _913 = _912 / _911;
          float _914 = 1.0f - _913;
          float _915 = _914 * (User_000.UserConstant_Z_000[4].y);
          float _916 = _913 * (User_000.UserConstant_Z_000[4].w);
          float _917 = _915 + _916;
          float _918 = _914 * _914;
          float _919 = _918 * _914;
          float _920 = _919 - _914;
          float _921 = _920 * (User_000.UserConstant_Z_000[10].x);
          float _922 = _913 * _913;
          float _923 = _922 * _913;
          float _924 = _923 - _913;
          float _925 = _924 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _932 = !(_871 <= (User_000.UserConstant_Z_000[9].x));
          if (!_932) {
            float _934 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _935 = max(9.999999974752427e-07f, _934);
            float _936 = _871 - (User_000.UserConstant_Z_000[4].z);
            float _937 = _936 / _935;
            float _938 = 1.0f - _937;
            float _939 = _938 * (User_000.UserConstant_Z_000[4].w);
            float _940 = _937 * (User_000.UserConstant_Z_000[9].y);
            ...
            float _949 = _948 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _956 = !(_871 <= (User_000.UserConstant_Z_000[9].z));
            if (!_956) {
              float _958 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _959 = max(9.999999974752427e-07f, _958);
              float _960 = _871 - (User_000.UserConstant_Z_000[9].x);
              float _961 = _960 / _959;
              float _962 = 1.0f - _961;
              float _963 = _962 * (User_000.UserConstant_Z_000[9].y);
              float _964 = _961 * (User_000.UserConstant_Z_000[9].w);
              ...
              float _973 = _972 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _980 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _981 = _871 - (User_000.UserConstant_Z_000[9].z);
              float _982 = max(9.999999974752427e-07f, _980);
              float _983 = _981 / _982;
              float _984 = 1.0f - _983;
              float _985 = _984 * (User_000.UserConstant_Z_000[9].w);
              float _986 = _985 + _983;
              float _987 = _984 * _984;
              float _988 = _987 * _984;
              float _989 = _988 - _984;
              float _990 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
      ...
      bool _998 = !(_872 <= (User_000.UserConstant_Z_000[4].x));
      if (!_998) {
        float _1000 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        float _1001 = _872 / _1000;
        float _1002 = _1001 * (User_000.UserConstant_Z_000[4].y);
        float _1003 = _1001 * _1001;
        float _1004 = _1003 * _1001;
        float _1005 = _1004 - _1001;
        float _1006 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _1012 = !(_872 <= (User_000.UserConstant_Z_000[4].z));
        if (!_1012) {
          float _1014 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _1015 = max(9.999999974752427e-07f, _1014);
          float _1016 = _872 - (User_000.UserConstant_Z_000[4].x);
          float _1017 = _1016 / _1015;
          float _1018 = 1.0f - _1017;
          float _1019 = _1018 * (User_000.UserConstant_Z_000[4].y);
          float _1020 = _1017 * (User_000.UserConstant_Z_000[4].w);
          float _1021 = _1019 + _1020;
          float _1022 = _1018 * _1018;
          float _1023 = _1022 * _1018;
          float _1024 = _1023 - _1018;
          float _1025 = _1024 * (User_000.UserConstant_Z_000[10].x);
          float _1026 = _1017 * _1017;
          float _1027 = _1026 * _1017;
          float _1028 = _1027 - _1017;
          float _1029 = _1028 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _1036 = !(_872 <= (User_000.UserConstant_Z_000[9].x));
          if (!_1036) {
            float _1038 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _1039 = max(9.999999974752427e-07f, _1038);
            float _1040 = _872 - (User_000.UserConstant_Z_000[4].z);
            float _1041 = _1040 / _1039;
            float _1042 = 1.0f - _1041;
            float _1043 = _1042 * (User_000.UserConstant_Z_000[4].w);
            float _1044 = _1041 * (User_000.UserConstant_Z_000[9].y);
            ...
            float _1053 = _1052 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _1060 = !(_872 <= (User_000.UserConstant_Z_000[9].z));
            if (!_1060) {
              float _1062 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _1063 = max(9.999999974752427e-07f, _1062);
              float _1064 = _872 - (User_000.UserConstant_Z_000[9].x);
              float _1065 = _1064 / _1063;
              float _1066 = 1.0f - _1065;
              float _1067 = _1066 * (User_000.UserConstant_Z_000[9].y);
              float _1068 = _1065 * (User_000.UserConstant_Z_000[9].w);
              ...
              float _1077 = _1076 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _1084 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _1085 = _872 - (User_000.UserConstant_Z_000[9].z);
              float _1086 = max(9.999999974752427e-07f, _1084);
              float _1087 = _1085 / _1086;
              float _1088 = 1.0f - _1087;
              float _1089 = _1088 * (User_000.UserConstant_Z_000[9].w);
              float _1090 = _1089 + _1087;
              float _1091 = _1088 * _1088;
              float _1092 = _1091 * _1088;
              float _1093 = _1092 - _1088;
              float _1094 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
      ...
      bool _1102 = !(_873 <= (User_000.UserConstant_Z_000[4].x));
      if (!_1102) {
        float _1104 = max(9.999999974752427e-07f, (User_000.UserConstant_Z_000[4].x));
        float _1105 = _873 / _1104;
        float _1106 = _1105 * (User_000.UserConstant_Z_000[4].y);
        float _1107 = _1105 * _1105;
        float _1108 = _1107 * _1105;
        float _1109 = _1108 - _1105;
        float _1110 = (User_000.UserConstant_Z_000[10].x) * 0.1666666716337204f;
        ...
        bool _1116 = !(_873 <= (User_000.UserConstant_Z_000[4].z));
        if (!_1116) {
          float _1118 = (User_000.UserConstant_Z_000[4].z) - (User_000.UserConstant_Z_000[4].x);
          float _1119 = max(9.999999974752427e-07f, _1118);
          float _1120 = _873 - (User_000.UserConstant_Z_000[4].x);
          float _1121 = _1120 / _1119;
          float _1122 = 1.0f - _1121;
          float _1123 = _1122 * (User_000.UserConstant_Z_000[4].y);
          float _1124 = _1121 * (User_000.UserConstant_Z_000[4].w);
          float _1125 = _1123 + _1124;
          float _1126 = _1122 * _1122;
          float _1127 = _1126 * _1122;
          float _1128 = _1127 - _1122;
          float _1129 = _1128 * (User_000.UserConstant_Z_000[10].x);
          float _1130 = _1121 * _1121;
          float _1131 = _1130 * _1121;
          float _1132 = _1131 - _1121;
          float _1133 = _1132 * (User_000.UserConstant_Z_000[10].y);
          ...
          bool _1140 = !(_873 <= (User_000.UserConstant_Z_000[9].x));
          if (!_1140) {
            float _1142 = (User_000.UserConstant_Z_000[9].x) - (User_000.UserConstant_Z_000[4].z);
            float _1143 = max(9.999999974752427e-07f, _1142);
            float _1144 = _873 - (User_000.UserConstant_Z_000[4].z);
            float _1145 = _1144 / _1143;
            float _1146 = 1.0f - _1145;
            float _1147 = _1146 * (User_000.UserConstant_Z_000[4].w);
            float _1148 = _1145 * (User_000.UserConstant_Z_000[9].y);
            ...
            float _1157 = _1156 * (User_000.UserConstant_Z_000[10].z);
            ...
            bool _1164 = !(_873 <= (User_000.UserConstant_Z_000[9].z));
            if (!_1164) {
              float _1166 = (User_000.UserConstant_Z_000[9].z) - (User_000.UserConstant_Z_000[9].x);
              float _1167 = max(9.999999974752427e-07f, _1166);
              float _1168 = _873 - (User_000.UserConstant_Z_000[9].x);
              float _1169 = _1168 / _1167;
              float _1170 = 1.0f - _1169;
              float _1171 = _1170 * (User_000.UserConstant_Z_000[9].y);
              float _1172 = _1169 * (User_000.UserConstant_Z_000[9].w);
              ...
              float _1181 = _1180 * (User_000.UserConstant_Z_000[10].w);
              ...
              float _1188 = 1.0f - (User_000.UserConstant_Z_000[9].z);
              float _1189 = _873 - (User_000.UserConstant_Z_000[9].z);
              float _1190 = max(9.999999974752427e-07f, _1188);
              float _1191 = _1189 / _1190;
              float _1192 = 1.0f - _1191;
              float _1193 = _1192 * (User_000.UserConstant_Z_000[9].w);
              float _1194 = _1193 + _1191;
              float _1195 = _1192 * _1192;
              float _1196 = _1195 * _1192;
              float _1197 = _1196 - _1192;
              float _1198 = (User_000.UserConstant_Z_000[10].w) * 0.1666666716337204f;
    ...
    if (_1222) {
      ...
      if (!_1225) {
        ...
        bool _1228 = (_1227 == 0);
        if (!_1228) {
          float _1232 = (User_000.UserConstant_Z_000[5].x) * 0.5f;
          float _1233 = _1232 + 0.5f;
          bool _1234 = (_1233 < 0.5f);
          float _1235 = (User_000.UserConstant_Z_000[5].x) * 5.0f;
          float _1236 = select(_1234, (User_000.UserConstant_Z_000[5].x), _1235);
          ...
          float _1248 = _1246 - (User_000.UserConstant_Z_000[5].y);
          ...
          float _1256 = 1.0f - (User_000.UserConstant_Z_000[5].z);
          ...
          if (!_1279) {
            float _1283 = abs(User_000.UserConstant_Z_000[5].x);
            float _1284 = saturate(_1283);
            uint4 _1286 = 0u; t15.GetDimensions(0u, _1286.x, _1286.y, _1286.w);
            ...
            if (!_1291) {
              ...
              int _1297 = _1295 & 63;
              int _1298 = _1296 & 63;
              float4 _1300 = t6.Load(int4(_1297, _1298, 0, 0));
            ...
            float4 _1366 = t15.Sample(s1, float2(_1361, _1356));
            float4 _1370 = t15.Sample(s1, float2(_1364, _1356));
  ...
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      float3((User_000.UserConstant_Z_000[8].x) * _1410, (User_000.UserConstant_Z_000[8].y) * _1411, (User_000.UserConstant_Z_000[8].z) * _1412),
      SV_Position.xy);
  float _1419 = apt_perceptual_film_grain.x;
  float _1420 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
  ...
  float _1430 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  float _1431 = _1430 / _1420;
  float _1432 = select(_1427, _1429, _1431);
  float _1433 = apt_perceptual_film_grain.y;
  ...
  float _1443 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  float _1444 = _1443 / _1420;
  float _1445 = select(_1440, _1442, _1444);
  float _1446 = apt_perceptual_film_grain.z;
  ...
  float _1456 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1459 = apt_post_process_output.x;
  float _1460 = apt_post_process_output.y;
  float _1461 = apt_post_process_output.z;
  ...
  int _1488 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  uint _1489 = uint(SV_Position.x);
  uint _1490 = uint(SV_Position.y);
  int _1491 = _1489 & 63;
  int _1492 = _1490 & 63;
  float4 _1494 = t1.Load(int4(_1491, _1492, _1488, 0));
