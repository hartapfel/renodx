...
float4 main(
  ...
  float _676 = apt_scaled_lut_output.x;
  float _677 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 2.0f;
  float _678 = log2(_676);
  float _679 = _677 * _678;
  float _680 = exp2(_679);
  float _681 = _680 + -1.0f;
  float _682 = _676 + -1.0f;
  float _683 = _681 / _682;
  bool _684 = !(_676 == 1.0f);
  float _685 = _683 + -1.0f;
  float _686 = _685 / _683;
  float _687 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  float _688 = _687 / _677;
  float _689 = select(_684, _686, _688);
  float _690 = apt_scaled_lut_output.y;
  float _691 = log2(_690);
  float _692 = _691 * _677;
  float _693 = exp2(_692);
  float _694 = _693 + -1.0f;
  float _695 = _690 + -1.0f;
  float _696 = _694 / _695;
  bool _697 = !(_690 == 1.0f);
  float _698 = _696 + -1.0f;
  float _699 = _698 / _696;
  float _700 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  float _701 = _700 / _677;
  float _702 = select(_697, _699, _701);
  float _703 = apt_scaled_lut_output.z;
  float _704 = log2(_703);
  float _705 = _704 * _677;
  float _706 = exp2(_705);
  float _707 = _706 + -1.0f;
  float _708 = _703 + -1.0f;
  float _709 = _707 / _708;
  bool _710 = !(_703 == 1.0f);
  float _711 = _709 + -1.0f;
  float _712 = _711 / _709;
  float _713 = (PostProcess_000.PostProcessConstant_Z_000[17].y) + 1.0f;
  float _714 = _713 / _677;
  float _715 = select(_710, _712, _714);
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      float3(_676, _690, _703),
      float3(_689, _702, _715),
      true);
  float _716 = apt_post_process_output.x;
  float _717 = apt_post_process_output.y;
  float _718 = apt_post_process_output.z;
  float _719 = log2(_716);
  float _720 = log2(_717);
  float _721 = log2(_718);
  float _722 = _719 * 0.4166666567325592f;
  float _723 = _720 * 0.4166666567325592f;
  float _724 = _721 * 0.4166666567325592f;
  float _725 = exp2(_722);
  float _726 = exp2(_723);
  float _727 = exp2(_724);
  float _728 = _725 * 1.0549999475479126f;
  float _729 = _726 * 1.0549999475479126f;
  float _730 = _727 * 1.0549999475479126f;
  float _731 = _728 + -0.054999999701976776f;
  float _732 = _729 + -0.054999999701976776f;
  float _733 = _730 + -0.054999999701976776f;
  float _734 = _716 * 12.920000076293945f;
  float _735 = _717 * 12.920000076293945f;
  float _736 = _718 * 12.920000076293945f;
  bool _737 = (_716 <= 0.0031308000907301903f);
  bool _738 = (_717 <= 0.0031308000907301903f);
  bool _739 = (_718 <= 0.0031308000907301903f);
  float _740 = select(_737, _734, _731);
  float _741 = select(_738, _735, _732);
  float _742 = select(_739, _736, _733);
  float _743 = log2(_740);
  float _744 = log2(_741);
  float _745 = log2(_742);
  float _746 = floor(_743);
  float _747 = floor(_744);
  float _748 = floor(_745);
  float _749 = _746 + -6.0f;
  float _750 = _747 + -6.0f;
  float _751 = _748 + -5.0f;
  ...
  bool _756 = (_741 <= 0.0f);
  bool _757 = (_742 <= 0.0f);
  float _758 = select(_755, 0.0f, _752);
  float _759 = select(_756, 0.0f, _753);
  float _760 = select(_757, 0.0f, _754);
  int _763 = asint((Global_000.GlobalCB_Z_000.GlobalCB_Z__GlobalConstant_Z_000[1].w));
  uint _764 = uint(SV_Position.x);
  uint _765 = uint(SV_Position.y);
  int _766 = _764 & 63;
  int _767 = _765 & 63;
  float4 _769 = t1.Load(int4(_766, _767, _763, 0));
  float4 _772 = t6.Load(int4(_766, _767, _763, 0));
  float _775 = _769.x * _758;
  float _776 = _772.x * _759;
  float _777 = _772.y * _760;
  float _778 = _775 + _740;
  float _779 = _776 + _741;
  float _780 = _777 + _742;
  SV_Target.x = _778;
  SV_Target.y = _779;
  SV_Target.z = _780;
  SV_Target.w = _134.w;
