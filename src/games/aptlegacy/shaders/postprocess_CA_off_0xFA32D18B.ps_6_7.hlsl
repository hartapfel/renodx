...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _460 = apt_scaled_lut_output.x;
  _461 = apt_scaled_lut_output.y;
  _462 = apt_scaled_lut_output.z;
  bool _465 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_465) {
  ...
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1025 = apt_perceptual_film_grain.x;
  ...
  float _1039 = apt_perceptual_film_grain.y;
  ...
  float _1052 = apt_perceptual_film_grain.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1065 = apt_post_process_output.x;
  float _1066 = apt_post_process_output.y;
  float _1067 = apt_post_process_output.z;
