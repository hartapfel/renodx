...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _615 = apt_scaled_lut_output.x;
  _616 = apt_scaled_lut_output.y;
  _617 = apt_scaled_lut_output.z;
  bool _620 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_620) {
  ...
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1180 = apt_perceptual_film_grain.x;
  ...
  float _1194 = apt_perceptual_film_grain.y;
  ...
  float _1207 = apt_perceptual_film_grain.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1220 = apt_post_process_output.x;
  float _1221 = apt_post_process_output.y;
  float _1222 = apt_post_process_output.z;
