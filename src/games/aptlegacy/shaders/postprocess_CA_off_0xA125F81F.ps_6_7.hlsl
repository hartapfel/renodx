...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _903 = apt_scaled_lut_output.x;
  _904 = apt_scaled_lut_output.y;
  _905 = apt_scaled_lut_output.z;
  bool _908 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_908) {
  ...
  float3 apt_perceptual_film_grain = APTApplyPerceptualFilmGrain(
      ...
      SV_Position.xy);
  float _1468 = apt_perceptual_film_grain.x;
  ...
  float _1482 = apt_perceptual_film_grain.y;
  ...
  float _1495 = apt_perceptual_film_grain.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1508 = apt_post_process_output.x;
  float _1509 = apt_post_process_output.y;
  float _1510 = apt_post_process_output.z;
