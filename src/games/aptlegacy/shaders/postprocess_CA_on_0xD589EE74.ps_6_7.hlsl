...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _630 = apt_scaled_lut_output.x;
  _631 = apt_scaled_lut_output.y;
  _632 = apt_scaled_lut_output.z;
  bool _635 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_635) {
  ...
  _1291 = apt_film_grain_output.x;
  _1292 = apt_film_grain_output.y;
  _1293 = apt_film_grain_output.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1333 = apt_post_process_output.x;
  float _1334 = apt_post_process_output.y;
  float _1335 = apt_post_process_output.z;
