...
float4 main(
  ...
  float3 apt_scaled_lut_output = APTApplyPostProcessLUT(
      ...
      1.f.xxx);
  _906 = apt_scaled_lut_output.x;
  _907 = apt_scaled_lut_output.y;
  _908 = apt_scaled_lut_output.z;
  bool _911 = ((User_000.UserConstant_Z_000[3].x) > 0.0f) && !APTIsPsychoV();
  if (_911) {
  ...
  _1567 = apt_film_grain_output.x;
  _1568 = apt_film_grain_output.y;
  _1569 = apt_film_grain_output.z;
  ...
  float3 apt_post_process_output = APTApplyPostProcessToneMap(
      ...
      true);
  float _1609 = apt_post_process_output.x;
  float _1610 = apt_post_process_output.y;
  float _1611 = apt_post_process_output.z;
