...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .section = "Tone Mapping",
        .tooltip = "Controls how much of the game's original LUT luminance and contrast response is retained before PsychoV-25. 0% keeps only the LUT's color grading; 100% restores its full luminance curve.",
        .max = 100.f,
        .format = "%.0f%%",
        .is_enabled = []() { return IsPsychoV(); },
